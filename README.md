# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 465,767 | 🐛 73 | 📅 2026-05-05 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,896 | 🐛 36 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,896 | 🐛 36 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,418 | 🐛 63 | 🌐 Python | 📅 2026-05-12 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,184 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-09 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 722 | 🐛 27 | 🌐 C | 📅 2026-05-13 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 149 | 🐛 51 | 🌐 Go | 📅 2026-05-12 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,085 | 🐛 349 | 🌐 Go | 📅 2026-05-12 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,411 | 🐛 53 | 🌐 Python | 📅 2026-05-12 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,571 | 🐛 754 | 🌐 Python | 📅 2026-05-06 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,232 | 🐛 185 | 🌐 TypeScript | 📅 2026-05-13 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,356 | 🐛 50 | 🌐 Go | 📅 2026-04-26 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,624 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 1,012 | 🐛 58 | 🌐 PLpgSQL | 📅 2026-05-07 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,116 | 🐛 22 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,154 | 🐛 57 | 🌐 Python | 📅 2026-05-12 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,371 | 🐛 258 | 🌐 Go | 📅 2026-04-20 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,580 | 🐛 301 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 846 | 🐛 68 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
* [pgsh](https://github.com/sastraxi/pgsh) ⭐ 601 | 🐛 34 | 🌐 JavaScript | 📅 2023-01-11 - Branch your PostgreSQL Database like Git
* [sabiql](https://github.com/riii111/sabiql) ⭐ 188 | 🐛 0 | 🌐 Rust | 📅 2026-05-10 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,217 | 🐛 178 | 🌐 C | 📅 2026-05-12 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,639 | 🐛 111 | 🌐 Go | 📅 2026-05-07 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,514 | 🐛 353 | 🌐 Go | 📅 2026-05-12 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,020 | 🐛 186 | 🌐 Go | 📅 2026-05-13 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,483 | 🐛 1,063 | 🌐 C | 📅 2026-05-12 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,765 | 🐛 158 | 🌐 Rust | 📅 2026-05-13 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,765 | 🐛 158 | 🌐 Rust | 📅 2026-05-13 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,498 | 🐛 203 | 🌐 C | 📅 2026-05-05 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,779 | 🐛 134 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,702 | 🐛 56 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,218 | 🐛 186 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
* [pg\_shard](https://github.com/citusdata/pg_shard) ⭐ 1,063 | 🐛 38 | 🌐 C | 📅 2016-08-03 - Extension to scale out real-time reads and writes.
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 752 | 🐛 0 | 🌐 C | 📅 2026-05-11 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 578 | 🐛 9 | 🌐 Perl | 📅 2026-05-04 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,103 | 🐛 54 | 🌐 Go | 📅 2026-05-12 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,847 | 🐛 35 | 🌐 PLpgSQL | 📅 2026-05-11 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,515 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-12 - Queueing jobs in Postgres from Node.js like a boss.
...
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,706 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-11 - Online version of PostgreSQL configuration wizard.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,968 | 🐛 2,369 | 🌐 TypeScript | 📅 2026-05-12 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,115 | 🐛 387 | 🌐 Haskell | 📅 2026-05-13 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,462 | 🐛 95 | 🌐 Go | 📅 2026-05-12 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,413 | 🐛 467 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,549 | 🐛 148 | 🌐 Go | 📅 2026-04-30 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 4,011 | 🐛 17 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
...
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 3,013 | 🐛 13 | 🌐 Python | 📅 2026-05-12 - top like application for PostgreSQL server activity monitoring.
...
* [pgCenter](https://github.com/lesovsky/pgcenter) ⭐ 1,605 | 🐛 11 | 🌐 Go | 📅 2026-05-08 - Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,355 | 🐛 0 | 🌐 Go | 📅 2026-04-21 - Advanced job scheduler for PostgreSQL.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 47 | 🐛 33 | 🌐 C# | 📅 2026-05-12 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,128 | 🐛 513 | 🌐 JavaScript | 📅 2026-05-12, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,552 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,901 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-05, [postgres](https://github.com/porsager/postgres) ⭐ 8,639 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,886 | 🐛 51 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,789 | 🐛 254 | 🌐 Go | 📅 2026-05-09, [go-pg](https://github.com/go-pg/pg) ⭐ 5,785 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,939 | 🐛 165 | 🌐 Rust | 📅 2026-05-06, [pgx](https://github.com/tcdi/pgx) ⭐ 4,670 | 🐛 339 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 354 | 🐛 10 | 🌐 Rust | 📅 2026-05-10
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,685 | 🐛 213 | 🌐 C# | 📅 2026-05-13
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,402 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,209 | 🐛 7 | 🌐 Elixir | 📅 2026-05-12
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 35 | 🌐 R | 📅 2026-05-13, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,600 | 🐛 374 | 🌐 Go | 📅 2026-05-13 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,158 | 🐛 571 | 🌐 Go | 📅 2026-05-11 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,407 | 🐛 160 | 🌐 Go | 📅 2026-05-13 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,400 | 🐛 1 | 🌐 Java | 📅 2026-05-12 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 366 | 🐛 29 | 🌐 Go | 📅 2026-05-12 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,483 | 🐛 108 | 🌐 HTML | 📅 2026-05-13
