# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,331 | 🐛 60 | 📅 2026-04-02 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,334 | 🐛 61 | 🌐 Python | 📅 2026-04-08 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,114 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-11 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,547 | 🐛 93 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [pg\_back](https://github.com/orgrim/pg_back/) ⭐ 562 | 🐛 11 | 🌐 Go | 📅 2025-12-19 - pg\_back is a simple backup script
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,334 | 🐛 745 | 🌐 Python | 📅 2026-04-01 - Connect to any data source, easily visualize and share your data.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,974 | 🐛 22 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,101 | 🐛 66 | 🌐 Python | 📅 2026-04-01 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,262 | 🐛 254 | 🌐 Go | 📅 2026-04-10 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,566 | 🐛 299 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 831 | 🐛 63 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 160 | 🐛 3 | 🌐 Rust | 📅 2026-04-12 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,201 | 🐛 165 | 🌐 C | 📅 2026-04-12 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,557 | 🐛 113 | 🌐 Go | 📅 2026-04-10 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,001 | 🐛 175 | 🌐 Go | 📅 2026-04-12 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,424 | 🐛 1,061 | 🌐 C | 📅 2026-04-10 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,648 | 🐛 153 | 🌐 Rust | 📅 2026-04-12 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,648 | 🐛 153 | 🌐 Rust | 📅 2026-04-12 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,400 | 🐛 198 | 🌐 C | 📅 2026-04-08 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,740 | 🐛 134 | 🌐 C | 📅 2026-04-07 - Run periodic jobs in PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,385 | 🐛 83 | 🌐 C++ | 📅 2026-03-06 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,010 | 🐛 44 | 🌐 Go | 📅 2026-04-09 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,754 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-04-09 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,375 | 🐛 51 | 🌐 TypeScript | 📅 2026-04-10 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,828 | 🐛 15 | 🌐 Ruby | 📅 2026-04-04 - PostgreSQL insights made easy.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,872 | 🐛 388 | 🌐 Haskell | 📅 2026-04-11 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,111 | 🐛 516 | 🌐 JavaScript | 📅 2026-04-02, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,899 | 🐛 31 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,605 | 🐛 253 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,850 | 🐛 50 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,617 | 🐛 245 | 🌐 Go | 📅 2026-04-11, [go-pg](https://github.com/go-pg/pg) ⭐ 5,786 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,924 | 🐛 156 | 🌐 Rust | 📅 2026-04-04, [pgx](https://github.com/tcdi/pgx) ⭐ 4,447 | 🐛 340 | 🌐 Rust | 📅 2026-04-11, [wtx](https://github.com/c410-f3r/wtx) ⭐ 346 | 🐛 12 | 🌐 Rust | 📅 2026-04-06
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,672 | 🐛 211 | 🌐 C# | 📅 2026-04-11
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,401 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,206 | 🐛 6 | 🌐 Elixir | 📅 2026-04-11
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,401 | 🐛 335 | 🌐 Go | 📅 2026-04-11 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,141 | 🐛 571 | 🌐 Go | 📅 2026-04-07 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,392 | 🐛 158 | 🌐 Go | 📅 2026-04-08 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
