# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 466,790 | 🐛 76 | 📅 2026-05-05 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,428 | 🐛 63 | 🌐 Python | 📅 2026-05-12 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,191 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-15 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [repmgr](https://github.com/2ndQuadrant/repmgr) ⭐ 1,696 | 🐛 135 | 🌐 C | 📅 2026-03-28 - Open-source tool suite to manage replication and failover in a cluster of PostgreSQL servers.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,087 | 🐛 348 | 🌐 Go | 📅 2026-05-14 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,574 | 🐛 755 | 🌐 Python | 📅 2026-05-06 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,241 | 🐛 185 | 🌐 TypeScript | 📅 2026-05-16 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,358 | 🐛 50 | 🌐 Go | 📅 2026-04-26 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,122 | 🐛 22 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,165 | 🐛 54 | 🌐 Python | 📅 2026-05-12 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,385 | 🐛 260 | 🌐 Go | 📅 2026-05-14 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 190 | 🐛 0 | 🌐 Rust | 📅 2026-05-13 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,217 | 🐛 178 | 🌐 C | 📅 2026-05-15 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,643 | 🐛 113 | 🌐 Go | 📅 2026-05-15 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,517 | 🐛 358 | 🌐 Go | 📅 2026-05-15 - Prometheus exporter for PostgreSQL server metrics.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,489 | 🐛 1,054 | 🌐 C | 📅 2026-05-15 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,779 | 🐛 160 | 🌐 Rust | 📅 2026-05-15 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,779 | 🐛 160 | 🌐 Rust | 📅 2026-05-15 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,508 | 🐛 198 | 🌐 C | 📅 2026-05-14 - Adds fully-functional graph database support including Cypher queries.
...
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,220 | 🐛 186 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,112 | 🐛 55 | 🌐 Go | 📅 2026-05-15 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,856 | 🐛 35 | 🌐 PLpgSQL | 📅 2026-05-11 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,531 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-12 - Queueing jobs in Postgres from Node.js like a boss.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,969 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-05-14 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,126 | 🐛 381 | 🌐 Haskell | 📅 2026-05-16 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,466 | 🐛 95 | 🌐 Go | 📅 2026-05-12 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,417 | 🐛 467 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,550 | 🐛 150 | 🌐 Go | 📅 2026-04-30 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 4,014 | 🐛 17 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,358 | 🐛 0 | 🌐 Go | 📅 2026-04-21 - Advanced job scheduler for PostgreSQL.
...
* Go: [pq](https://github.com/lib/pq) ⭐ 9,887 | 🐛 51 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,805 | 🐛 253 | 🌐 Go | 📅 2026-05-13, [go-pg](https://github.com/go-pg/pg) ⭐ 5,788 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,940 | 🐛 166 | 🌐 Rust | 📅 2026-05-06, [pgx](https://github.com/tcdi/pgx) ⭐ 4,682 | 🐛 342 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 355 | 🐛 9 | 🌐 Rust | 📅 2026-05-16
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,686 | 🐛 215 | 🌐 C# | 📅 2026-05-15
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 35 | 🌐 R | 📅 2026-05-16, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,611 | 🐛 373 | 🌐 Go | 📅 2026-05-15 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,408 | 🐛 154 | 🌐 Go | 📅 2026-05-14 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,400 | 🐛 1 | 🌐 Java | 📅 2026-05-14 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 366 | 🐛 29 | 🌐 Go | 📅 2026-05-15 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,489 | 🐛 108 | 🌐 HTML | 📅 2026-05-16
