# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 463,811 | 🐛 71 | 📅 2026-05-05 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,885 | 🐛 36 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,885 | 🐛 36 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,410 | 🐛 57 | 🌐 Python | 📅 2026-05-07 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,168 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-02 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 719 | 🐛 27 | 🌐 C | 📅 2026-05-08 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 107 | 🐛 49 | 🌐 Go | 📅 2026-05-08 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,076 | 🐛 354 | 🌐 Go | 📅 2026-05-07 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,563 | 🐛 753 | 🌐 Python | 📅 2026-05-06 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,215 | 🐛 177 | 🌐 TypeScript | 📅 2026-05-07 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,348 | 🐛 50 | 🌐 Go | 📅 2026-04-26 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,073 | 🐛 23 | 🌐 Shell | 📅 2026-05-03 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,150 | 🐛 63 | 🌐 Python | 📅 2026-05-03 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,361 | 🐛 256 | 🌐 Go | 📅 2026-04-20 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,579 | 🐛 300 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,215 | 🐛 169 | 🌐 C | 📅 2026-05-08 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,629 | 🐛 110 | 🌐 Go | 📅 2026-05-07 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,510 | 🐛 357 | 🌐 Go | 📅 2026-05-06 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,016 | 🐛 185 | 🌐 Go | 📅 2026-05-08 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,477 | 🐛 1,060 | 🌐 C | 📅 2026-05-07 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,746 | 🐛 158 | 🌐 Rust | 📅 2026-05-08 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,746 | 🐛 158 | 🌐 Rust | 📅 2026-05-08 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,485 | 🐛 203 | 🌐 C | 📅 2026-05-05 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,774 | 🐛 133 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,696 | 🐛 55 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,393 | 🐛 69 | 🌐 C++ | 📅 2026-05-05 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,216 | 🐛 185 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 577 | 🐛 8 | 🌐 Perl | 📅 2026-05-04 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,091 | 🐛 57 | 🌐 Go | 📅 2026-05-07 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,838 | 🐛 35 | 🌐 PLpgSQL | 📅 2026-05-07 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,493 | 🐛 41 | 🌐 TypeScript | 📅 2026-05-02 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,857 | 🐛 15 | 🌐 Ruby | 📅 2026-04-27 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,466 | 🐛 68 | 🌐 TypeScript | 📅 2026-05-07 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,705 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-06 - Online version of PostgreSQL configuration wizard.
...
* [aqo](https://github.com/postgrespro/aqo) ⭐ 491 | 🐛 9 | 🌐 C | 📅 2026-02-25 - Adaptive query optimization for PostgreSQL.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,968 | 🐛 2,371 | 🌐 TypeScript | 📅 2026-05-06 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,079 | 🐛 379 | 🌐 Haskell | 📅 2026-05-07 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,458 | 🐛 94 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pREST](https://github.com/prest/prest) ⭐ 4,549 | 🐛 146 | 🌐 Go | 📅 2026-04-30 - Serve a RESTful API from any PostgreSQL database (Golang)
...
* [pgCenter](https://github.com/lesovsky/pgcenter) ⭐ 1,601 | 🐛 13 | 🌐 Go | 📅 2026-05-08 - Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 133 | 🐛 5 | 🌐 Python | 📅 2026-05-01 - Spot vulnerabilities in PostgreSQL extension scripts.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,123 | 🐛 523 | 🌐 JavaScript | 📅 2026-04-30, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,552 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,901 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-05, [postgres](https://github.com/porsager/postgres) ⭐ 8,634 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,879 | 🐛 49 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,774 | 🐛 256 | 🌐 Go | 📅 2026-04-25, [go-pg](https://github.com/go-pg/pg) ⭐ 5,783 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,937 | 🐛 164 | 🌐 Rust | 📅 2026-05-06, [pgx](https://github.com/tcdi/pgx) ⭐ 4,663 | 🐛 337 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 354 | 🐛 9 | 🌐 Rust | 📅 2026-05-02
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,681 | 🐛 211 | 🌐 C# | 📅 2026-05-07
...
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 856 | 🐛 18 | 🌐 C | 📅 2026-03-13
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 546 | 🐛 2 | 🌐 Zig | 📅 2026-04-25
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,579 | 🐛 367 | 🌐 Go | 📅 2026-05-08 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,152 | 🐛 572 | 🌐 Go | 📅 2026-04-29 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,396 | 🐛 1 | 🌐 Java | 📅 2026-05-07 -  Full Stack PostgreSQL on Kubernetes.
