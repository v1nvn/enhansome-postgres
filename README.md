# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 471,888 | 🐛 83 | 📅 2026-05-05 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,929 | 🐛 39 | 📅 2026-05-21 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,929 | 🐛 39 | 📅 2026-05-21 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,474 | 🐛 59 | 🌐 Python | 📅 2026-05-28 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,230 | 🐛 30 | 🌐 TypeScript | 📅 2026-06-01 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,345 | 🐛 123 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 174 | 🐛 58 | 🌐 Go | 📅 2026-05-29 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,104 | 🐛 338 | 🌐 Go | 📅 2026-06-01 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,590 | 🐛 95 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,614 | 🐛 763 | 🌐 Python | 📅 2026-06-01 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,284 | 🐛 187 | 🌐 TypeScript | 📅 2026-06-01 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,365 | 🐛 51 | 🌐 Go | 📅 2026-05-30 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,147 | 🐛 26 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,193 | 🐛 43 | 🌐 Python | 📅 2026-05-12 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,437 | 🐛 259 | 🌐 Go | 📅 2026-05-21 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,653 | 🐛 301 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [squix](https://github.com/eduardofuncao/squix) ⭐ 237 | 🐛 7 | 🌐 Go | 📅 2026-05-30 - SQL command-line client with query management and interactive results.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 194 | 🐛 3 | 🌐 Rust | 📅 2026-05-30 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,222 | 🐛 198 | 🌐 C | 📅 2026-06-01 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [Acra](https://github.com/cossacklabs/acra) ⭐ 1,480 | 🐛 20 | 🌐 Go | 📅 2026-04-23 - SQL database security suite: proxy for data protection with transparent "on the fly" data encryption, SQL firewall (SQL injections prevention), intrusion detection system.

### Monitoring

* [coroot](https://github.com/coroot/coroot) ⭐ 7,676 | 🐛 113 | 🌐 Go | 📅 2026-05-28 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,533 | 🐛 365 | 🌐 Go | 📅 2026-05-31 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,031 | 🐛 198 | 🌐 Go | 📅 2026-06-01 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,525 | 🐛 1,048 | 🌐 C | 📅 2026-05-30 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,877 | 🐛 175 | 🌐 Rust | 📅 2026-06-01 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,877 | 🐛 175 | 🌐 Rust | 📅 2026-06-01 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,564 | 🐛 200 | 🌐 C | 📅 2026-05-14 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,798 | 🐛 135 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,717 | 🐛 56 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,400 | 🐛 69 | 🌐 C++ | 📅 2026-05-20 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 760 | 🐛 1 | 🌐 C | 📅 2026-05-31 - Extension that allows to check plpgsql source code.
...
* [pgMemento](https://github.com/pgMemento/pgMemento) ⭐ 408 | 🐛 11 | 🌐 PLpgSQL | 📅 2026-04-27 - Provides an audit trail for your data inside a PostgreSQL database using triggers and server-side functions written in PL/pgSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,170 | 🐛 56 | 🌐 Go | 📅 2026-05-31 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,913 | 🐛 38 | 🌐 PLpgSQL | 📅 2026-05-20 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,583 | 🐛 49 | 🌐 TypeScript | 📅 2026-05-25 - Queueing jobs in Postgres from Node.js like a boss.
...
* [pgassistant](https://github.com/beh74/pgassistant-community) ⭐ 32 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-24 - A PostgreSQL tool for developers to help understand, optimize database with LLM and pgTune integration.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,191 | 🐛 386 | 🌐 Haskell | 📅 2026-05-31 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,483 | 🐛 91 | 🌐 Go | 📅 2026-05-27 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,429 | 🐛 468 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
...
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 3,015 | 🐛 15 | 🌐 Python | 📅 2026-05-18 - top like application for PostgreSQL server activity monitoring.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,363 | 🐛 0 | 🌐 Go | 📅 2026-04-21 - Advanced job scheduler for PostgreSQL.
...
* [mysql-postgresql-converter](https://github.com/lanyrd/mysql-postgresql-converter) ⭐ 1,311 | 🐛 29 | 🌐 Python | 📅 2022-09-16 - Lanyrd's MySQL to PostgreSQL conversion script.
...
* [bemi](https://github.com/BemiHQ/bemi) ⭐ 397 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-23 - Automatic data change tracking for PostgreSQL
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 134 | 🐛 6 | 🌐 Python | 📅 2026-06-01 - Spot vulnerabilities in PostgreSQL extension scripts.
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 114 | 🐛 6 | 🌐 Rust | 📅 2026-06-01 - Linter for dangerous Postgres migration patterns in Diesel and SQLx.
...
* [Qail](https://github.com/qail-io/qail) ⭐ 26 | 🐛 5 | 🌐 Rust | 📅 2026-06-01 - rust-first typed AST pipeline for PostgreSQL with compile-time query checks and built-in tenant scoping.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,145 | 🐛 505 | 🌐 JavaScript | 📅 2026-05-18, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,553 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,902 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-31, [postgres](https://github.com/porsager/postgres) ⭐ 8,651 | 🐛 258 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,900 | 🐛 51 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,855 | 🐛 249 | 🌐 Go | 📅 2026-05-31, [go-pg](https://github.com/go-pg/pg) ⭐ 5,789 | 🐛 121 | 🌐 Go | 📅 2026-05-29
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,938 | 🐛 170 | 🌐 Rust | 📅 2026-05-28, [pgx](https://github.com/tcdi/pgx) ⭐ 4,692 | 🐛 333 | 🌐 Rust | 📅 2026-05-31, [wtx](https://github.com/c410-f3r/wtx) ⭐ 358 | 🐛 8 | 🌐 Rust | 📅 2026-05-30
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,696 | 🐛 220 | 🌐 C# | 📅 2026-05-28
...
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 869 | 🐛 18 | 🌐 C | 📅 2026-05-16
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 557 | 🐛 3 | 🌐 Zig | 📅 2026-05-30, [qail-zig](https://github.com/qail-io/qail-zig) ⭐ 3 | 🐛 1 | 🌐 Zig | 📅 2026-05-15
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,707 | 🐛 375 | 🌐 Go | 📅 2026-06-01 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,172 | 🐛 573 | 🌐 Go | 📅 2026-05-29 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,413 | 🐛 155 | 🌐 Go | 📅 2026-05-29 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,403 | 🐛 1 | 🌐 Java | 📅 2026-05-31 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 371 | 🐛 37 | 🌐 Go | 📅 2026-06-01 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,498 | 🐛 112 | 🌐 HTML | 📅 2026-05-31
