# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,676 | 🐛 68 | 📅 2026-04-19 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,868 | 🐛 34 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,868 | 🐛 34 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,385 | 🐛 62 | 🌐 Python | 📅 2026-04-24 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,147 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-27 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 703 | 🐛 25 | 🌐 C | 📅 2026-04-27 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 102 | 🐛 51 | 🌐 Go | 📅 2026-04-27 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,040 | 🐛 344 | 🌐 Go | 📅 2026-04-27 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,568 | 🐛 93 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,408 | 🐛 53 | 🌐 Python | 📅 2026-03-11 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,540 | 🐛 752 | 🌐 Python | 📅 2026-04-19 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,177 | 🐛 173 | 🌐 TypeScript | 📅 2026-04-28 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,334 | 🐛 49 | 🌐 Go | 📅 2026-04-26 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,623 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 1,006 | 🐛 53 | 🌐 PLpgSQL | 📅 2026-04-27 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,048 | 🐛 23 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,128 | 🐛 60 | 🌐 Python | 📅 2026-04-27 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,327 | 🐛 254 | 🌐 Go | 📅 2026-04-20 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,575 | 🐛 299 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 839 | 🐛 64 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 169 | 🐛 1 | 🌐 Rust | 📅 2026-04-26 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,211 | 🐛 162 | 🌐 C | 📅 2026-04-28 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,581 | 🐛 111 | 🌐 Go | 📅 2026-04-24 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,501 | 🐛 352 | 🌐 Go | 📅 2026-04-23 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,012 | 🐛 173 | 🌐 Go | 📅 2026-04-27 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [pg\_ash](https://github.com/NikolayS/pg_ash) ⭐ 219 | 🐛 0 | 🌐 PLpgSQL | 📅 2026-04-25 - Active Session History for PostgreSQL. Samples pg\_stat\_activity once per second via pg\_cron, stores encoded snapshots, and provides 32 SQL functions for wait event analysis. Pure SQL, no extensions, works on managed providers (RDS, Cloud SQL, Supabase, etc.).
* [check\_pgactivity](https://github.com/OPMDG/check_pgactivity) ⭐ 181 | 🐛 48 | 🌐 Perl | 📅 2026-04-27 - check\_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,447 | 🐛 1,060 | 🌐 C | 📅 2026-04-27 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,704 | 🐛 159 | 🌐 Rust | 📅 2026-04-28 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,704 | 🐛 159 | 🌐 Rust | 📅 2026-04-28 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,459 | 🐛 199 | 🌐 C | 📅 2026-04-27 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,766 | 🐛 133 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,683 | 🐛 52 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,786 | 🐛 70 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,640 | 🐛 5 | 🌐 C | 📅 2026-04-18 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,389 | 🐛 84 | 🌐 C++ | 📅 2026-04-15 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 573 | 🐛 9 | 🌐 Perl | 📅 2026-04-27 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,060 | 🐛 52 | 🌐 Go | 📅 2026-04-27 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,814 | 🐛 41 | 🌐 PLpgSQL | 📅 2026-04-27 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,443 | 🐛 39 | 🌐 TypeScript | 📅 2026-04-26 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,458 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-07 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,701 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-23 - Online version of PostgreSQL configuration wizard.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,963 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-04-25 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,039 | 🐛 371 | 🌐 Haskell | 📅 2026-04-27 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,919 | 🐛 149 | 🌐 TypeScript | 📅 2026-04-26 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,451 | 🐛 94 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pREST](https://github.com/prest/prest) ⭐ 4,546 | 🐛 146 | 🌐 Go | 📅 2026-04-27 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 4,002 | 🐛 16 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
...
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 3,012 | 🐛 13 | 🌐 Python | 📅 2026-01-13 - top like application for PostgreSQL server activity monitoring.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,349 | 🐛 0 | 🌐 Go | 📅 2026-04-21 - Advanced job scheduler for PostgreSQL.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 47 | 🐛 39 | 🌐 C# | 📅 2026-04-27 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,114 | 🐛 522 | 🌐 JavaScript | 📅 2026-04-22, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,551 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,900 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,626 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,869 | 🐛 49 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,712 | 🐛 248 | 🌐 Go | 📅 2026-04-25, [go-pg](https://github.com/go-pg/pg) ⭐ 5,783 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,932 | 🐛 163 | 🌐 Rust | 📅 2026-04-23, [pgx](https://github.com/tcdi/pgx) ⭐ 4,480 | 🐛 332 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 354 | 🐛 11 | 🌐 Rust | 📅 2026-04-22
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,679 | 🐛 209 | 🌐 C# | 📅 2026-04-24
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 541 | 🐛 2 | 🌐 Zig | 📅 2026-04-25
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,515 | 🐛 352 | 🌐 Go | 📅 2026-04-28 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,146 | 🐛 574 | 🌐 Go | 📅 2026-04-27 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,400 | 🐛 162 | 🌐 Go | 📅 2026-04-08 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,389 | 🐛 1 | 🌐 Java | 📅 2026-04-27 -  Full Stack PostgreSQL on Kubernetes.
...
* [pg-utils](https://github.com/dataegret/pg-utils) ⭐ 1,205 | 🐛 6 | 🌐 Shell | 📅 2025-12-05 - Useful DBA tools by Data Egret
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,472 | 🐛 100 | 🌐 HTML | 📅 2026-04-25
