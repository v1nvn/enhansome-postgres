# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,674 | 🐛 20 | 📅 2026-01-05 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,674 | 🐛 20 | 📅 2026-01-05 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,143 | 🐛 71 | 🌐 Python | 📅 2026-01-29 - Template for PostgreSQL HA with ZooKeeper or etcd.
* [Stolon](https://github.com/sorintlab/stolon) ⭐ 4,805 | 🐛 154 | 🌐 Go | 📅 2024-07-08 - PostgreSQL HA based on Consul or etcd, with Kubernetes integration.
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,908 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-09 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,322 | 🐛 121 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 666 | 🐛 23 | 🌐 C | 📅 2026-02-08 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,495 | 🐛 92 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,207 | 🐛 735 | 🌐 Python | 📅 2026-02-07 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 20,833 | 🐛 156 | 🌐 TypeScript | 📅 2026-02-09 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,249 | 🐛 41 | 🌐 Go | 📅 2026-02-01 - Web-based PostgreSQL database browser written in Go.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,016 | 🐛 60 | 🌐 Python | 📅 2026-01-17 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,059 | 🐛 239 | 🌐 Go | 📅 2026-02-07 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,535 | 🐛 297 | 🌐 HTML | 📅 2026-01-26 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,188 | 🐛 159 | 🌐 C | 📅 2026-02-08 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [PMM](https://github.com/percona/pmm) ⭐ 962 | 🐛 173 | 🌐 Go | 📅 2026-02-09 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [check\_pgactivity](https://github.com/OPMDG/check_pgactivity) ⭐ 180 | 🐛 49 | 🌐 Perl | 📅 2026-02-08 - check\_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,272 | 🐛 1,054 | 🌐 C | 📅 2026-02-06 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,297 | 🐛 114 | 🌐 Rust | 📅 2026-02-09 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,297 | 🐛 114 | 🌐 Rust | 📅 2026-02-09 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,213 | 🐛 180 | 🌐 C | 📅 2026-02-03 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,657 | 🐛 128 | 🌐 C | 📅 2025-12-22 - Run periodic jobs in PostgreSQL.
...
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,605 | 🐛 4 | 🌐 C | 📅 2026-02-08 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,369 | 🐛 72 | 🌐 C++ | 📅 2026-02-07 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 553 | 🐛 9 | 🌐 Perl | 📅 2026-02-08 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,797 | 🐛 40 | 🌐 Go | 📅 2026-02-09 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,474 | 🐛 39 | 🌐 PLpgSQL | 📅 2026-02-08 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,174 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-06 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,346 | 🐛 70 | 🌐 TypeScript | 📅 2026-02-02 - Online Postgres Explain Visualizer.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,893 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-06 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,480 | 🐛 371 | 🌐 Haskell | 📅 2026-02-08 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-07 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,278 | 🐛 463 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
...
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,100 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
* [migra](https://github.com/djrobstep/migra) ⭐ 3,051 | 🐛 86 | 🌐 Python | 📅 2025-08-25 - Like diff but for Postgres schemas.
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 2,993 | 🐛 13 | 🌐 Python | 📅 2026-01-13 - top like application for PostgreSQL server activity monitoring.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,317 | 🐛 1 | 🌐 Go | 📅 2026-01-29 - Advanced job scheduler for PostgreSQL.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,053 | 🐛 501 | 🌐 JavaScript | 📅 2026-02-05, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-03, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-04, [slonik](https://github.com/gajus/slonik) ⭐ 4,885 | 🐛 30 | 🌐 TypeScript | 📅 2026-01-16, [postgres](https://github.com/porsager/postgres) ⭐ 8,543 | 🐛 250 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,788 | 🐛 87 | 🌐 Go | 📅 2026-01-29, [pgx](https://github.com/jackc/pgx) ⭐ 13,300 | 🐛 256 | 🌐 Go | 📅 2026-02-02, [go-pg](https://github.com/go-pg/pg) ⭐ 5,788 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,897 | 🐛 147 | 🌐 Rust | 📅 2026-02-03, [pgx](https://github.com/tcdi/pgx) ⭐ 4,358 | 🐛 331 | 🌐 Rust | 📅 2026-02-04, [wtx](https://github.com/c410-f3r/wtx) ⭐ 341 | 🐛 12 | 🌐 Rust | 📅 2026-02-03
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,650 | 🐛 234 | 🌐 C# | 📅 2026-02-07
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,399 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,200 | 🐛 5 | 🌐 Elixir | 📅 2026-02-01
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 853 | 🐛 18 | 🌐 C | 📅 2026-02-03
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 485 | 🐛 4 | 🌐 Zig | 📅 2026-01-09
* Common Lisp: [Postmodern](https://github.com/marijnh/Postmodern) ⭐ 425 | 🐛 5 | 🌐 Common Lisp | 📅 2025-07-24
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 29 | 🌐 R | 📅 2026-02-07, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 7,979 | 🐛 280 | 🌐 Go | 📅 2026-02-09 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,077 | 🐛 554 | 🌐 Go | 📅 2026-02-06 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,360 | 🐛 1 | 🌐 Java | 📅 2026-02-06 -  Full Stack PostgreSQL on Kubernetes.
* [Kubegres Operator](https://github.com/reactive-tech/kubegres) ⭐ 1,354 | 🐛 79 | 🌐 Go | 📅 2025-01-04 - Kubegres is a Kubernetes operator allowing to deploy one or many clusters of PostgreSql instances and manage databases replication, failover and backup.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,426 | 🐛 56 | 🌐 PLpgSQL | 📅 2026-02-05
