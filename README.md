# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,094 | 🐛 77 | 📅 2026-03-09 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,225 | 🐛 73 | 🌐 Python | 📅 2026-03-05 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,029 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-10 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 682 | 🐛 29 | 🌐 C | 📅 2026-03-13 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,962 | 🐛 334 | 🌐 Go | 📅 2026-03-12 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,522 | 🐛 92 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,276 | 🐛 744 | 🌐 Python | 📅 2026-03-12 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,012 | 🐛 147 | 🌐 TypeScript | 📅 2026-03-12 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 991 | 🐛 51 | 🌐 PLpgSQL | 📅 2026-03-12 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,071 | 🐛 59 | 🌐 Python | 📅 2026-02-22 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,162 | 🐛 248 | 🌐 Go | 📅 2026-03-08 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,191 | 🐛 165 | 🌐 C | 📅 2026-03-13 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,473 | 🐛 112 | 🌐 Go | 📅 2026-03-12 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 985 | 🐛 176 | 🌐 Go | 📅 2026-03-13 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,364 | 🐛 1,050 | 🌐 C | 📅 2026-03-12 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,528 | 🐛 121 | 🌐 Rust | 📅 2026-03-13 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,528 | 🐛 121 | 🌐 Rust | 📅 2026-03-13 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,291 | 🐛 181 | 🌐 C | 📅 2026-03-03 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,694 | 🐛 131 | 🌐 C | 📅 2026-03-12 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,626 | 🐛 48 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,204 | 🐛 185 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 559 | 🐛 9 | 🌐 Perl | 📅 2026-03-12 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,870 | 🐛 44 | 🌐 Go | 📅 2026-03-09 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,613 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-03-05 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,287 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-11 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,807 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,417 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-11 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,672 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-10 - Online version of PostgreSQL configuration wizard.
...
* [TimescaleDB Tune](https://github.com/timescale/timescaledb-tune) ⭐ 491 | 🐛 17 | 🌐 Go | 📅 2025-12-23 - a program for tuning a TimescaleDB database to perform its best based on the host's resources such as memory and number of CPUs.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,918 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-12 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,650 | 🐛 386 | 🌐 Haskell | 📅 2026-03-13 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,340 | 🐛 464 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,532 | 🐛 145 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,977 | 🐛 15 | 🌐 Perl | 📅 2026-02-21 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,434 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,326 | 🐛 0 | 🌐 Go | 📅 2026-03-12 - Advanced job scheduler for PostgreSQL.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,090 | 🐛 510 | 🌐 JavaScript | 📅 2026-03-07, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-11, [slonik](https://github.com/gajus/slonik) ⭐ 4,893 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-13, [postgres](https://github.com/porsager/postgres) ⭐ 8,583 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,826 | 🐛 65 | 🌐 Go | 📅 2026-03-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,566 | 🐛 251 | 🌐 Go | 📅 2026-03-09, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,917 | 🐛 151 | 🌐 Rust | 📅 2026-02-27, [pgx](https://github.com/tcdi/pgx) ⭐ 4,392 | 🐛 338 | 🌐 Rust | 📅 2026-03-08, [wtx](https://github.com/c410-f3r/wtx) ⭐ 344 | 🐛 13 | 🌐 Rust | 📅 2026-03-11
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,660 | 🐛 248 | 🌐 C# | 📅 2026-03-13
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,399 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,204 | 🐛 7 | 🌐 Elixir | 📅 2026-03-09
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 336 | 🐛 31 | 🌐 R | 📅 2026-03-13, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,206 | 🐛 298 | 🌐 Go | 📅 2026-03-13 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 358 | 🐛 34 | 🌐 Go | 📅 2026-03-12 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,432 | 🐛 88 | 🌐 PLpgSQL | 📅 2026-03-13
