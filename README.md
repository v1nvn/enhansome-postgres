# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 447,390 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,262 | 🐛 64 | 🌐 Python | 📅 2026-03-20 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,059 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-20 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,971 | 🐛 335 | 🌐 Go | 📅 2026-03-20 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,291 | 🐛 735 | 🌐 Python | 📅 2026-03-19 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,040 | 🐛 149 | 🌐 TypeScript | 📅 2026-03-20 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,272 | 🐛 44 | 🌐 Go | 📅 2026-03-01 - Web-based PostgreSQL database browser written in Go.
...
* [phpPgAdmin](https://github.com/phppgadmin/phppgadmin) ⭐ 841 | 🐛 74 | 🌐 PHP | 📅 2024-07-30 - The Premier Web Based Administration Tool for PostgreSQL.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,079 | 🐛 62 | 🌐 Python | 📅 2026-02-22 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,194 | 🐛 250 | 🌐 Go | 📅 2026-03-16 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,191 | 🐛 160 | 🌐 C | 📅 2026-03-20 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [Acra](https://github.com/cossacklabs/acra) ⭐ 1,458 | 🐛 19 | 🌐 Go | 📅 2026-03-18 - SQL database security suite: proxy for data protection with transparent "on the fly" data encryption, SQL firewall (SQL injections prevention), intrusion detection system.

### Monitoring

* [coroot](https://github.com/coroot/coroot) ⭐ 7,496 | 🐛 113 | 🌐 Go | 📅 2026-03-17 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 991 | 🐛 167 | 🌐 Go | 📅 2026-03-20 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,388 | 🐛 1,056 | 🌐 C | 📅 2026-03-20 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,571 | 🐛 124 | 🌐 Rust | 📅 2026-03-20 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,571 | 🐛 124 | 🌐 Rust | 📅 2026-03-20 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,326 | 🐛 184 | 🌐 C | 📅 2026-03-03 - Adds fully-functional graph database support including Cypher queries.
...
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,635 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-03-19 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,316 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-13 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,817 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,432 | 🐛 70 | 🌐 TypeScript | 📅 2026-03-20 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,676 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-10 - Online version of PostgreSQL configuration wizard.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,919 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-17 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,678 | 🐛 386 | 🌐 Haskell | 📅 2026-03-20 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,912 | 🐛 158 | 🌐 TypeScript | 📅 2026-03-20 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
...
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,115 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 130 | 🐛 6 | 🌐 Python | 📅 2026-03-14 - Spot vulnerabilities in PostgreSQL extension scripts.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 46 | 🐛 37 | 🌐 C# | 📅 2026-03-17 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,097 | 🐛 510 | 🌐 JavaScript | 📅 2026-03-07, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,551 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-14, [slonik](https://github.com/gajus/slonik) ⭐ 4,893 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-13, [postgres](https://github.com/porsager/postgres) ⭐ 8,593 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,829 | 🐛 58 | 🌐 Go | 📅 2026-03-18, [pgx](https://github.com/jackc/pgx) ⭐ 13,561 | 🐛 242 | 🌐 Go | 📅 2026-03-20, [go-pg](https://github.com/go-pg/pg) ⭐ 5,785 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,920 | 🐛 151 | 🌐 Rust | 📅 2026-03-14, [pgx](https://github.com/tcdi/pgx) ⭐ 4,411 | 🐛 338 | 🌐 Rust | 📅 2026-03-20, [wtx](https://github.com/c410-f3r/wtx) ⭐ 345 | 🐛 13 | 🌐 Rust | 📅 2026-03-15
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,665 | 🐛 211 | 🌐 C# | 📅 2026-03-19
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,399 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,205 | 🐛 6 | 🌐 Elixir | 📅 2026-03-19
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 856 | 🐛 18 | 🌐 C | 📅 2026-03-13
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 509 | 🐛 4 | 🌐 Zig | 📅 2026-02-23
* Common Lisp: [Postmodern](https://github.com/marijnh/Postmodern) ⭐ 429 | 🐛 5 | 🌐 Common Lisp | 📅 2025-07-24
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 31 | 🌐 R | 📅 2026-03-21, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,257 | 🐛 311 | 🌐 Go | 📅 2026-03-21 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,381 | 🐛 155 | 🌐 Go | 📅 2026-03-18 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,380 | 🐛 1 | 🌐 Java | 📅 2026-03-17 -  Full Stack PostgreSQL on Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,432 | 🐛 88 | 🌐 PLpgSQL | 📅 2026-03-20
