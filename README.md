# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 465,426 | 🐛 73 | 📅 2026-05-05 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,893 | 🐛 36 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,893 | 🐛 36 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,417 | 🐛 60 | 🌐 Python | 📅 2026-05-08 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,182 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-09 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 722 | 🐛 27 | 🌐 C | 📅 2026-05-12 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 122 | 🐛 50 | 🌐 Go | 📅 2026-05-11 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,083 | 🐛 350 | 🌐 Go | 📅 2026-05-11 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,564 | 🐛 755 | 🌐 Python | 📅 2026-05-06 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,225 | 🐛 186 | 🌐 TypeScript | 📅 2026-05-12 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,354 | 🐛 50 | 🌐 Go | 📅 2026-04-26 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,113 | 🐛 22 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,154 | 🐛 61 | 🌐 Python | 📅 2026-05-12 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,368 | 🐛 257 | 🌐 Go | 📅 2026-04-20 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,216 | 🐛 178 | 🌐 C | 📅 2026-05-08 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,635 | 🐛 110 | 🌐 Go | 📅 2026-05-07 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,514 | 🐛 356 | 🌐 Go | 📅 2026-05-12 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,018 | 🐛 185 | 🌐 Go | 📅 2026-05-11 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,483 | 🐛 1,062 | 🌐 C | 📅 2026-05-11 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,761 | 🐛 158 | 🌐 Rust | 📅 2026-05-12 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,761 | 🐛 158 | 🌐 Rust | 📅 2026-05-12 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,495 | 🐛 203 | 🌐 C | 📅 2026-05-05 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,777 | 🐛 134 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
...
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,217 | 🐛 186 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,101 | 🐛 55 | 🌐 Go | 📅 2026-05-12 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,844 | 🐛 35 | 🌐 PLpgSQL | 📅 2026-05-11 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,508 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-12 - Queueing jobs in Postgres from Node.js like a boss.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,969 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-05-11 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,104 | 🐛 390 | 🌐 Haskell | 📅 2026-05-11 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,462 | 🐛 96 | 🌐 Go | 📅 2026-05-08 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 4,010 | 🐛 17 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
...
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 3,013 | 🐛 15 | 🌐 Python | 📅 2026-05-11 - top like application for PostgreSQL server activity monitoring.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,354 | 🐛 0 | 🌐 Go | 📅 2026-04-21 - Advanced job scheduler for PostgreSQL.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 47 | 🐛 32 | 🌐 C# | 📅 2026-05-11 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,127 | 🐛 513 | 🌐 JavaScript | 📅 2026-05-11, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,552 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,901 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-05, [postgres](https://github.com/porsager/postgres) ⭐ 8,637 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,884 | 🐛 51 | 🌐 Go | 📅 2026-05-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,787 | 🐛 253 | 🌐 Go | 📅 2026-05-09, [go-pg](https://github.com/go-pg/pg) ⭐ 5,785 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,939 | 🐛 165 | 🌐 Rust | 📅 2026-05-06, [pgx](https://github.com/tcdi/pgx) ⭐ 4,668 | 🐛 339 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 354 | 🐛 10 | 🌐 Rust | 📅 2026-05-10
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,684 | 🐛 212 | 🌐 C# | 📅 2026-05-11
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 35 | 🌐 R | 📅 2026-05-12, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,597 | 🐛 380 | 🌐 Go | 📅 2026-05-12 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,154 | 🐛 571 | 🌐 Go | 📅 2026-05-11 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,406 | 🐛 159 | 🌐 Go | 📅 2026-05-11 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,398 | 🐛 1 | 🌐 Java | 📅 2026-05-11 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 365 | 🐛 29 | 🌐 Go | 📅 2026-05-11 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,483 | 🐛 108 | 🌐 HTML | 📅 2026-05-12
