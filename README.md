# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,832 | 🐛 67 | 📅 2026-01-28 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,680 | 🐛 20 | 📅 2026-01-05 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,680 | 🐛 20 | 📅 2026-01-05 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,151 | 🐛 74 | 🌐 Python | 📅 2026-01-29 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,916 | 🐛 33 | 🌐 TypeScript | 📅 2026-02-09 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 669 | 🐛 18 | 🌐 C | 📅 2026-02-11 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,931 | 🐛 337 | 🌐 Go | 📅 2026-02-11 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,499 | 🐛 92 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,395 | 🐛 55 | 🌐 Python | 📅 2026-02-11 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,217 | 🐛 736 | 🌐 Python | 📅 2026-02-10 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 20,864 | 🐛 150 | 🌐 TypeScript | 📅 2026-02-12 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,252 | 🐛 41 | 🌐 Go | 📅 2026-02-01 - Web-based PostgreSQL database browser written in Go.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,019 | 🐛 59 | 🌐 Python | 📅 2026-01-17 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,076 | 🐛 239 | 🌐 Go | 📅 2026-02-07 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,538 | 🐛 297 | 🌐 HTML | 📅 2026-01-26 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,188 | 🐛 164 | 🌐 C | 📅 2026-02-11 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,384 | 🐛 117 | 🌐 Go | 📅 2026-02-05 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 965 | 🐛 172 | 🌐 Go | 📅 2026-02-12 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,282 | 🐛 1,049 | 🌐 C | 📅 2026-02-11 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,323 | 🐛 117 | 🌐 Rust | 📅 2026-02-12 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,323 | 🐛 117 | 🌐 Rust | 📅 2026-02-12 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,217 | 🐛 181 | 🌐 C | 📅 2026-02-11 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,661 | 🐛 128 | 🌐 C | 📅 2025-12-22 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,593 | 🐛 52 | 🌐 PLpgSQL | 📅 2026-02-09 - Partition management extension for PostgreSQL.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 737 | 🐛 2 | 🌐 C | 📅 2026-02-11 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 554 | 🐛 8 | 🌐 Perl | 📅 2026-02-11 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,802 | 🐛 41 | 🌐 Go | 📅 2026-02-11 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,500 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-02-08 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,190 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-11 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,786 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,899 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-11 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,507 | 🐛 381 | 🌐 Haskell | 📅 2026-02-08 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-11 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,284 | 🐛 463 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,273 | 🐛 91 | 🌐 Go | 📅 2026-02-03 - Zero-downtime, reversible, schema migrations for Postgres
* [pREST](https://github.com/prest/prest) ⭐ 4,519 | 🐛 147 | 🌐 Go | 📅 2026-02-11 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,942 | 🐛 15 | 🌐 Perl | 📅 2026-02-05 - Fast PostgreSQL Log Analyzer.
...
* [pgCenter](https://github.com/lesovsky/pgcenter) ⭐ 1,590 | 🐛 13 | 🌐 Go | 📅 2026-01-06 - Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,317 | 🐛 2 | 🌐 Go | 📅 2026-01-29 - Advanced job scheduler for PostgreSQL.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,060 | 🐛 500 | 🌐 JavaScript | 📅 2026-02-12, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-04, [slonik](https://github.com/gajus/slonik) ⭐ 4,887 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-11, [postgres](https://github.com/porsager/postgres) ⭐ 8,543 | 🐛 250 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,788 | 🐛 86 | 🌐 Go | 📅 2026-02-10, [pgx](https://github.com/jackc/pgx) ⭐ 13,318 | 🐛 255 | 🌐 Go | 📅 2026-02-11, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,898 | 🐛 148 | 🌐 Rust | 📅 2026-02-03, [pgx](https://github.com/tcdi/pgx) ⭐ 4,361 | 🐛 333 | 🌐 Rust | 📅 2026-02-09, [wtx](https://github.com/c410-f3r/wtx) ⭐ 342 | 🐛 12 | 🌐 Rust | 📅 2026-02-11
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,652 | 🐛 234 | 🌐 C# | 📅 2026-02-11
...
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 854 | 🐛 15 | 🌐 C | 📅 2026-02-11
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 30 | 🌐 R | 📅 2026-02-12, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 7,998 | 🐛 286 | 🌐 Go | 📅 2026-02-12 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,080 | 🐛 556 | 🌐 Go | 📅 2026-02-06 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,363 | 🐛 147 | 🌐 Go | 📅 2026-02-11 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,359 | 🐛 1 | 🌐 Java | 📅 2026-02-11 -  Full Stack PostgreSQL on Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,427 | 🐛 59 | 🌐 PLpgSQL | 📅 2026-02-10
