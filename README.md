# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 447,075 | 🐛 86 | 📅 2026-03-09 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,252 | 🐛 65 | 🌐 Python | 📅 2026-03-19 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,056 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-20 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 686 | 🐛 31 | 🌐 C | 📅 2026-03-19 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,971 | 🐛 338 | 🌐 Go | 📅 2026-03-19 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,525 | 🐛 92 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,287 | 🐛 735 | 🌐 Python | 📅 2026-03-19 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,039 | 🐛 149 | 🌐 TypeScript | 📅 2026-03-20 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,270 | 🐛 44 | 🌐 Go | 📅 2026-03-01 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,623 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 993 | 🐛 50 | 🌐 PLpgSQL | 📅 2026-03-19 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,078 | 🐛 62 | 🌐 Python | 📅 2026-02-22 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,191 | 🐛 249 | 🌐 Go | 📅 2026-03-16 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pgplan](https://github.com/JacobArthurs/pgplan) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2026-03-10 - compare and analyze PostgreSQL EXPLAIN plans from the CLI
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,191 | 🐛 162 | 🌐 C | 📅 2026-03-20 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,489 | 🐛 113 | 🌐 Go | 📅 2026-03-17 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 990 | 🐛 173 | 🌐 Go | 📅 2026-03-19 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,385 | 🐛 1,056 | 🌐 C | 📅 2026-03-19 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,565 | 🐛 121 | 🌐 Rust | 📅 2026-03-20 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,565 | 🐛 121 | 🌐 Rust | 📅 2026-03-20 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,323 | 🐛 184 | 🌐 C | 📅 2026-03-03 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,708 | 🐛 131 | 🌐 C | 📅 2026-03-12 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,641 | 🐛 49 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,786 | 🐛 69 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,617 | 🐛 5 | 🌐 C | 📅 2026-02-22 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,378 | 🐛 74 | 🌐 C++ | 📅 2026-03-06 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [pg\_squeeze](https://github.com/cybertec-postgresql/pg_squeeze) ⭐ 654 | 🐛 2 | 🌐 C | 📅 2025-10-08 - An extension for automatic bloat cleanup with minimal locking.
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 559 | 🐛 10 | 🌐 Perl | 📅 2026-03-19 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,886 | 🐛 45 | 🌐 Go | 📅 2026-03-19 - A high-performance job processing system for Go and Postgres.
...
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,311 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-13 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,813 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,432 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-11 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,677 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-10 - Online version of PostgreSQL configuration wizard.
...
* [TimescaleDB Tune](https://github.com/timescale/timescaledb-tune) ⭐ 493 | 🐛 17 | 🌐 Go | 📅 2025-12-23 - a program for tuning a TimescaleDB database to perform its best based on the host's resources such as memory and number of CPUs.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,925 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-17 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,672 | 🐛 386 | 🌐 Haskell | 📅 2026-03-20 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,912 | 🐛 158 | 🌐 TypeScript | 📅 2026-03-19 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,393 | 🐛 92 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pREST](https://github.com/prest/prest) ⭐ 4,533 | 🐛 147 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,979 | 🐛 16 | 🌐 Perl | 📅 2026-02-21 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,435 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,114 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
...
* [pg-formatter](https://github.com/gajus/pg-formatter) ⭐ 83 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-05 - A PostgreSQL SQL syntax beautifier (Node.js).
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,096 | 🐛 510 | 🌐 JavaScript | 📅 2026-03-07, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-14, [slonik](https://github.com/gajus/slonik) ⭐ 4,893 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-13, [postgres](https://github.com/porsager/postgres) ⭐ 8,593 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,828 | 🐛 58 | 🌐 Go | 📅 2026-03-18, [pgx](https://github.com/jackc/pgx) ⭐ 13,552 | 🐛 242 | 🌐 Go | 📅 2026-03-20, [go-pg](https://github.com/go-pg/pg) ⭐ 5,786 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,919 | 🐛 151 | 🌐 Rust | 📅 2026-03-14, [pgx](https://github.com/tcdi/pgx) ⭐ 4,409 | 🐛 339 | 🌐 Rust | 📅 2026-03-18, [wtx](https://github.com/c410-f3r/wtx) ⭐ 344 | 🐛 13 | 🌐 Rust | 📅 2026-03-15
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,666 | 🐛 211 | 🌐 C# | 📅 2026-03-19
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 502 | 🐛 4 | 🌐 Zig | 📅 2026-02-23
* Common Lisp: [Postmodern](https://github.com/marijnh/Postmodern) ⭐ 429 | 🐛 5 | 🌐 Common Lisp | 📅 2025-07-24
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 31 | 🌐 R | 📅 2026-03-15, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,250 | 🐛 315 | 🌐 Go | 📅 2026-03-20 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,116 | 🐛 559 | 🌐 Go | 📅 2026-03-17 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,433 | 🐛 88 | 🌐 PLpgSQL | 📅 2026-03-20
