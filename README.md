# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,297 | 🐛 80 | 📅 2026-03-09 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,235 | 🐛 73 | 🌐 Python | 📅 2026-03-05 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,032 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-10 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 683 | 🐛 27 | 🌐 C | 📅 2026-03-13 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,962 | 🐛 335 | 🌐 Go | 📅 2026-03-12 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,523 | 🐛 92 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,277 | 🐛 743 | 🌐 Python | 📅 2026-03-13 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,014 | 🐛 148 | 🌐 TypeScript | 📅 2026-03-14 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,072 | 🐛 59 | 🌐 Python | 📅 2026-02-22 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,167 | 🐛 248 | 🌐 Go | 📅 2026-03-08 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 812 | 🐛 58 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,191 | 🐛 166 | 🌐 C | 📅 2026-03-13 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,476 | 🐛 112 | 🌐 Go | 📅 2026-03-12 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 985 | 🐛 175 | 🌐 Go | 📅 2026-03-13 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,366 | 🐛 1,051 | 🌐 C | 📅 2026-03-13 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,537 | 🐛 117 | 🌐 Rust | 📅 2026-03-14 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,537 | 🐛 117 | 🌐 Rust | 📅 2026-03-14 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,293 | 🐛 181 | 🌐 C | 📅 2026-03-03 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,696 | 🐛 131 | 🌐 C | 📅 2026-03-12 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,629 | 🐛 48 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,377 | 🐛 73 | 🌐 C++ | 📅 2026-03-06 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,872 | 🐛 45 | 🌐 Go | 📅 2026-03-13 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,615 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-03-05 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,291 | 🐛 39 | 🌐 TypeScript | 📅 2026-03-13 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,423 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-11 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,673 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-10 - Online version of PostgreSQL configuration wizard.
...
* [pgassistant](https://github.com/beh74/pgassistant-community) ⭐ 26 | 🐛 0 | 🌐 CSS | 📅 2026-03-02 - A PostgreSQL tool for developers to help understand, optimize database with LLM and pgTune integration.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,922 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-12 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,654 | 🐛 387 | 🌐 Haskell | 📅 2026-03-14 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,911 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-11 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,382 | 🐛 92 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,342 | 🐛 464 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,532 | 🐛 145 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,977 | 🐛 16 | 🌐 Perl | 📅 2026-02-21 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,435 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,113 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 130 | 🐛 5 | 🌐 Python | 📅 2026-03-03 - Spot vulnerabilities in PostgreSQL extension scripts.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,091 | 🐛 510 | 🌐 JavaScript | 📅 2026-03-07, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-13, [slonik](https://github.com/gajus/slonik) ⭐ 4,894 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-13, [postgres](https://github.com/porsager/postgres) ⭐ 8,584 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,828 | 🐛 65 | 🌐 Go | 📅 2026-03-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,513 | 🐛 251 | 🌐 Go | 📅 2026-03-09, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,918 | 🐛 151 | 🌐 Rust | 📅 2026-02-27, [pgx](https://github.com/tcdi/pgx) ⭐ 4,397 | 🐛 337 | 🌐 Rust | 📅 2026-03-13, [wtx](https://github.com/c410-f3r/wtx) ⭐ 344 | 🐛 13 | 🌐 Rust | 📅 2026-03-11
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,661 | 🐛 238 | 🌐 C# | 📅 2026-03-13
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 336 | 🐛 31 | 🌐 R | 📅 2026-03-14, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,214 | 🐛 311 | 🌐 Go | 📅 2026-03-14 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,108 | 🐛 556 | 🌐 Go | 📅 2026-03-02 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,378 | 🐛 154 | 🌐 Go | 📅 2026-03-12 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,377 | 🐛 1 | 🌐 Java | 📅 2026-03-10 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 358 | 🐛 33 | 🌐 Go | 📅 2026-03-13 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [pg-utils](https://github.com/dataegret/pg-utils) ⭐ 1,194 | 🐛 6 | 🌐 Shell | 📅 2025-12-05 - Useful DBA tools by Data Egret
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,433 | 🐛 88 | 🌐 PLpgSQL | 📅 2026-03-13
