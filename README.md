# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,982 | 🐛 70 | 📅 2026-01-28 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,176 | 🐛 71 | 🌐 Python | 📅 2026-01-29 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,945 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-20 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,327 | 🐛 121 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 672 | 🐛 27 | 🌐 C | 📅 2026-02-20 - 100% open-source logical multi-master PostgreSQL replication.
...
* [PAF](https://github.com/ClusterLabs/PAF) ⭐ 347 | 🐛 19 | 🌐 Perl | 📅 2024-06-13 - PostgreSQL Automatic Failover: High-Availibility for Postgres, based on Pacemaker and Corosync.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 84 | 🐛 32 | 🌐 Go | 📅 2026-02-16 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,937 | 🐛 336 | 🌐 Go | 📅 2026-02-16 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,506 | 🐛 92 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,400 | 🐛 53 | 🌐 Python | 📅 2026-02-18 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,236 | 🐛 741 | 🌐 Python | 📅 2026-02-20 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 20,893 | 🐛 140 | 🌐 TypeScript | 📅 2026-02-13 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,257 | 🐛 42 | 🌐 Go | 📅 2026-02-17 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,622 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 981 | 🐛 47 | 🌐 PLpgSQL | 📅 2026-02-20 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [temBoard](https://github.com/dalibo/temboard) ⭐ 753 | 🐛 85 | 🌐 Python | 📅 2025-12-11 - Web-based PostgreSQL GUI and monitoring.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,034 | 🐛 58 | 🌐 Python | 📅 2026-02-20 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,098 | 🐛 244 | 🌐 Go | 📅 2026-02-07 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,538 | 🐛 296 | 🌐 HTML | 📅 2026-02-20 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 799 | 🐛 56 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,187 | 🐛 164 | 🌐 C | 📅 2026-02-20 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,402 | 🐛 113 | 🌐 Go | 📅 2026-02-20 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [dexter](https://github.com/ankane/dexter) ⭐ 2,068 | 🐛 2 | 🌐 Ruby | 📅 2025-12-26 - The automatic indexer for Postgres. Detects slow queries and creates indexes if configured to do so.
...
* [PMM](https://github.com/percona/pmm) ⭐ 965 | 🐛 168 | 🌐 Go | 📅 2026-02-20 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,300 | 🐛 1,051 | 🌐 C | 📅 2026-02-20 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,379 | 🐛 114 | 🌐 Rust | 📅 2026-02-21 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,379 | 🐛 114 | 🌐 Rust | 📅 2026-02-21 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,234 | 🐛 178 | 🌐 C | 📅 2026-02-16 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,666 | 🐛 129 | 🌐 C | 📅 2025-12-22 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,601 | 🐛 56 | 🌐 PLpgSQL | 📅 2026-02-17 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,786 | 🐛 69 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,607 | 🐛 4 | 🌐 C | 📅 2026-02-08 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,371 | 🐛 68 | 🌐 C++ | 📅 2026-02-19 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 739 | 🐛 0 | 🌐 C | 📅 2026-02-18 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 557 | 🐛 8 | 🌐 Perl | 📅 2026-02-20 - Query Performance Monitoring tool for PostgreSQL.
...
* [Atlas4D](https://github.com/crisbez/atlas4d-base) ⭐ 8 | 🐛 8 | 🌐 HTML | 📅 2025-12-25 - Open-source 4D spatiotemporal platform combining PostGIS, TimescaleDB, pgvector, and H3 for unified geospatial and time-series intelligence.

### Work Queues

* [river](https://github.com/riverqueue/river) ⭐ 4,829 | 🐛 42 | 🌐 Go | 📅 2026-02-16 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,547 | 🐛 40 | 🌐 PLpgSQL | 📅 2026-02-19 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,218 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-20 - Queueing jobs in Postgres from Node.js like a boss.
* [BeanQueue](https://github.com/LaunchPlatform/bq) ⭐ 24 | 🐛 2 | 🌐 Python | 📅 2026-02-16 - A Python work queue framework based on SKIP LOCKED, LISTEN and NOTIFY
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,797 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,360 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-18 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,659 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-20 - Online version of PostgreSQL configuration wizard.
...
* [pgassistant](https://github.com/beh74/pgassistant-community) ⭐ 24 | 🐛 0 | 🌐 CSS | 📅 2026-02-18 - A PostgreSQL tool for developers to help understand, optimize database with LLM and pgTune integration.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,902 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-19 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,546 | 🐛 381 | 🌐 Haskell | 📅 2026-02-20 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,905 | 🐛 143 | 🌐 TypeScript | 📅 2026-02-20 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,297 | 🐛 464 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,279 | 🐛 90 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
* [pREST](https://github.com/prest/prest) ⭐ 4,519 | 🐛 147 | 🌐 Go | 📅 2026-02-11 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,951 | 🐛 17 | 🌐 Perl | 📅 2026-02-05 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,430 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,105 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
* [migra](https://github.com/djrobstep/migra) ⭐ 3,054 | 🐛 86 | 🌐 Python | 📅 2025-08-25 - Like diff but for Postgres schemas.
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 2,995 | 🐛 13 | 🌐 Python | 📅 2026-01-13 - top like application for PostgreSQL server activity monitoring.
...
* [ERAlchemy](https://github.com/Alexis-benoist/eralchemy) ⭐ 1,400 | 🐛 10 | 🌐 Python | 📅 2026-01-12 - ERAlchemy generates Entity Relation (ER) diagram from databases.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,320 | 🐛 1 | 🌐 Go | 📅 2026-02-13 - Advanced job scheduler for PostgreSQL.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 46 | 🐛 32 | 🌐 C# | 📅 2026-02-18 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,067 | 🐛 499 | 🌐 JavaScript | 📅 2026-02-13, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-04, [slonik](https://github.com/gajus/slonik) ⭐ 4,890 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-16, [postgres](https://github.com/porsager/postgres) ⭐ 8,562 | 🐛 250 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,794 | 🐛 84 | 🌐 Go | 📅 2026-02-18, [pgx](https://github.com/jackc/pgx) ⭐ 13,434 | 🐛 251 | 🌐 Go | 📅 2026-02-20, [go-pg](https://github.com/go-pg/pg) ⭐ 5,786 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,906 | 🐛 149 | 🌐 Rust | 📅 2026-02-03, [pgx](https://github.com/tcdi/pgx) ⭐ 4,369 | 🐛 332 | 🌐 Rust | 📅 2026-02-09, [wtx](https://github.com/c410-f3r/wtx) ⭐ 343 | 🐛 12 | 🌐 Rust | 📅 2026-02-11
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,654 | 🐛 242 | 🌐 C# | 📅 2026-02-19
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 490 | 🐛 4 | 🌐 Zig | 📅 2026-02-18
* Common Lisp: [Postmodern](https://github.com/marijnh/Postmodern) ⭐ 427 | 🐛 5 | 🌐 Common Lisp | 📅 2025-07-24
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 29 | 🌐 R | 📅 2026-02-17, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,056 | 🐛 313 | 🌐 Go | 📅 2026-02-21 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,093 | 🐛 555 | 🌐 Go | 📅 2026-02-21 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,369 | 🐛 145 | 🌐 Go | 📅 2026-02-18 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,364 | 🐛 1 | 🌐 Java | 📅 2026-02-18 -  Full Stack PostgreSQL on Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,430 | 🐛 76 | 🌐 PLpgSQL | 📅 2026-02-20
