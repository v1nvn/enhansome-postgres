# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 473,857 | 🐛 84 | 📅 2026-06-02 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,943 | 🐛 41 | 📅 2026-05-21 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,943 | 🐛 41 | 📅 2026-05-21 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,490 | 🐛 61 | 🌐 Python | 📅 2026-06-05 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,251 | 🐛 27 | 🌐 TypeScript | 📅 2026-06-05 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,348 | 🐛 124 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 728 | 🐛 28 | 🌐 C | 📅 2026-06-07 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 176 | 🐛 58 | 🌐 Go | 📅 2026-06-04 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,623 | 🐛 787 | 🌐 Python | 📅 2026-06-01 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,314 | 🐛 188 | 🌐 TypeScript | 📅 2026-06-08 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,372 | 🐛 52 | 🌐 Go | 📅 2026-06-03 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,160 | 🐛 26 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,204 | 🐛 39 | 🌐 Python | 📅 2026-06-03 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,464 | 🐛 257 | 🌐 Go | 📅 2026-06-04 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 197 | 🐛 3 | 🌐 Rust | 📅 2026-06-07 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,225 | 🐛 206 | 🌐 C | 📅 2026-06-08 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,718 | 🐛 116 | 🌐 Go | 📅 2026-06-03 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,538 | 🐛 369 | 🌐 Go | 📅 2026-06-03 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,037 | 🐛 197 | 🌐 Go | 📅 2026-06-08 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,544 | 🐛 1,047 | 🌐 C | 📅 2026-06-06 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,913 | 🐛 164 | 🌐 Rust | 📅 2026-06-08 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,913 | 🐛 164 | 🌐 Rust | 📅 2026-06-08 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,578 | 🐛 195 | 🌐 C | 📅 2026-06-03 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,802 | 🐛 135 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,722 | 🐛 56 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,785 | 🐛 70 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,657 | 🐛 4 | 🌐 C | 📅 2026-05-24 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,405 | 🐛 69 | 🌐 C++ | 📅 2026-05-20 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,221 | 🐛 185 | 🌐 C | 📅 2026-06-01 - Extension that provides logical streaming replication.
* [pg\_shard](https://github.com/citusdata/pg_shard) ⭐ 1,062 | 🐛 38 | 🌐 C | 📅 2016-08-03 - Extension to scale out real-time reads and writes.
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 763 | 🐛 1 | 🌐 C | 📅 2026-06-05 - Extension that allows to check plpgsql source code.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,191 | 🐛 58 | 🌐 Go | 📅 2026-06-08 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,936 | 🐛 38 | 🌐 PLpgSQL | 📅 2026-05-20 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,606 | 🐛 52 | 🌐 TypeScript | 📅 2026-06-04 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,484 | 🐛 71 | 🌐 TypeScript | 📅 2026-06-02 - Online Postgres Explain Visualizer.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,037 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-06-05 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,207 | 🐛 379 | 🌐 Haskell | 📅 2026-06-07 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,927 | 🐛 155 | 🌐 TypeScript | 📅 2026-06-06 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,494 | 🐛 93 | 🌐 Go | 📅 2026-06-03 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,435 | 🐛 467 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
...
* [Qail](https://github.com/qail-io/qail) ⭐ 26 | 🐛 5 | 🌐 Rust | 📅 2026-06-08 - rust-first typed AST pipeline for PostgreSQL with compile-time query checks and built-in tenant scoping.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,152 | 🐛 512 | 🌐 JavaScript | 📅 2026-06-02, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,553 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,904 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-05, [postgres](https://github.com/porsager/postgres) ⭐ 8,657 | 🐛 259 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,897 | 🐛 52 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,893 | 🐛 245 | 🌐 Go | 📅 2026-06-03, [go-pg](https://github.com/go-pg/pg) ⭐ 5,788 | 🐛 121 | 🌐 Go | 📅 2026-05-29
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,938 | 🐛 171 | 🌐 Rust | 📅 2026-05-28, [pgx](https://github.com/tcdi/pgx) ⭐ 4,704 | 🐛 319 | 🌐 Rust | 📅 2026-06-08, [wtx](https://github.com/c410-f3r/wtx) ⭐ 358 | 🐛 9 | 🌐 Rust | 📅 2026-06-07
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,697 | 🐛 223 | 🌐 C# | 📅 2026-06-07
...
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 870 | 🐛 20 | 🌐 C | 📅 2026-06-07
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 559 | 🐛 3 | 🌐 Zig | 📅 2026-06-03, [qail-zig](https://github.com/qail-io/qail-zig) ⭐ 3 | 🐛 1 | 🌐 Zig | 📅 2026-05-15
* Common Lisp: [Postmodern](https://github.com/marijnh/Postmodern) ⭐ 430 | 🐛 5 | 🌐 Common Lisp | 📅 2025-07-24
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 338 | 🐛 36 | 🌐 R | 📅 2026-05-25, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 49 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,757 | 🐛 376 | 🌐 Go | 📅 2026-06-07 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,180 | 🐛 563 | 🌐 Go | 📅 2026-06-04 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,498 | 🐛 114 | 🌐 HTML | 📅 2026-06-08
