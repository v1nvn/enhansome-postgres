# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 461,193 | 🐛 68 | 📅 2026-04-19 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,875 | 🐛 36 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,875 | 🐛 36 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,398 | 🐛 64 | 🌐 Python | 📅 2026-04-24 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,155 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-01 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [repmgr](https://github.com/2ndQuadrant/repmgr) ⭐ 1,692 | 🐛 135 | 🌐 C | 📅 2026-03-28 - Open-source tool suite to manage replication and failover in a cluster of PostgreSQL servers.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 705 | 🐛 24 | 🌐 C | 📅 2026-05-01 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 106 | 🐛 53 | 🌐 Go | 📅 2026-05-02 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,052 | 🐛 346 | 🌐 Go | 📅 2026-05-01 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,574 | 🐛 94 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,550 | 🐛 753 | 🌐 Python | 📅 2026-05-01 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,195 | 🐛 174 | 🌐 TypeScript | 📅 2026-04-30 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,063 | 🐛 23 | 🌐 Shell | 📅 2026-05-01 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,138 | 🐛 61 | 🌐 Python | 📅 2026-04-27 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,344 | 🐛 255 | 🌐 Go | 📅 2026-04-20 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 173 | 🐛 3 | 🌐 Rust | 📅 2026-05-02 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,596 | 🐛 111 | 🌐 Go | 📅 2026-04-30 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,504 | 🐛 353 | 🌐 Go | 📅 2026-05-01 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,013 | 🐛 176 | 🌐 Go | 📅 2026-05-01 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [pg\_exporter](https://github.com/Vonng/pg_exporter) ⭐ 346 | 🐛 13 | 🌐 Go | 📅 2026-04-14 - Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,461 | 🐛 1,061 | 🌐 C | 📅 2026-05-01 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,718 | 🐛 168 | 🌐 Rust | 📅 2026-05-02 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,718 | 🐛 168 | 🌐 Rust | 📅 2026-05-02 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,471 | 🐛 202 | 🌐 C | 📅 2026-04-30 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,768 | 🐛 133 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,688 | 🐛 52 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,392 | 🐛 71 | 🌐 C++ | 📅 2026-05-01 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,074 | 🐛 53 | 🌐 Go | 📅 2026-05-01 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,824 | 🐛 41 | 🌐 PLpgSQL | 📅 2026-04-29 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,465 | 🐛 41 | 🌐 TypeScript | 📅 2026-05-02 - Queueing jobs in Postgres from Node.js like a boss.
...
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,703 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-23 - Online version of PostgreSQL configuration wizard.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,060 | 🐛 376 | 🌐 Haskell | 📅 2026-04-30 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,921 | 🐛 153 | 🌐 TypeScript | 📅 2026-04-28 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,456 | 🐛 94 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
...
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 111 | 🐛 9 | 🌐 Rust | 📅 2026-05-02 - Linter for dangerous Postgres migration patterns in Diesel and SQLx.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,122 | 🐛 523 | 🌐 JavaScript | 📅 2026-04-30, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,551 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,900 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,630 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,870 | 🐛 49 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,731 | 🐛 251 | 🌐 Go | 📅 2026-04-25, [go-pg](https://github.com/go-pg/pg) ⭐ 5,783 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,933 | 🐛 163 | 🌐 Rust | 📅 2026-04-23, [pgx](https://github.com/tcdi/pgx) ⭐ 4,652 | 🐛 333 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 354 | 🐛 10 | 🌐 Rust | 📅 2026-05-01
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,543 | 🐛 361 | 🌐 Go | 📅 2026-05-01 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 364 | 🐛 34 | 🌐 Go | 📅 2026-05-01 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,474 | 🐛 103 | 🌐 HTML | 📅 2026-05-01
