# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,320 | 🐛 60 | 📅 2026-04-02 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,816 | 🐛 24 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,816 | 🐛 24 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,325 | 🐛 70 | 🌐 Python | 📅 2026-04-03 - Template for PostgreSQL HA with ZooKeeper or etcd.
* [Stolon](https://github.com/sorintlab/stolon) ⭐ 4,814 | 🐛 152 | 🌐 Go | 📅 2024-07-08 - PostgreSQL HA based on Consul or etcd, with Kubernetes integration.
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,104 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-04 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [repmgr](https://github.com/2ndQuadrant/repmgr) ⭐ 1,684 | 🐛 135 | 🌐 C | 📅 2026-03-28 - Open-source tool suite to manage replication and failover in a cluster of PostgreSQL servers.
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,333 | 🐛 123 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 691 | 🐛 24 | 🌐 C | 📅 2026-04-06 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 87 | 🐛 38 | 🌐 Go | 📅 2026-04-03 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,996 | 🐛 335 | 🌐 Go | 📅 2026-04-03 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,539 | 🐛 93 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [pg\_back](https://github.com/orgrim/pg_back/) ⭐ 564 | 🐛 11 | 🌐 Go | 📅 2025-12-19 - pg\_back is a simple backup script
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,326 | 🐛 744 | 🌐 Python | 📅 2026-04-01 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,086 | 🐛 163 | 🌐 TypeScript | 📅 2026-04-04 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,289 | 🐛 46 | 🌐 Go | 📅 2026-04-02 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,623 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 999 | 🐛 51 | 🌐 PLpgSQL | 📅 2026-04-03 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,963 | 🐛 21 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,096 | 🐛 65 | 🌐 Python | 📅 2026-04-01 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,244 | 🐛 254 | 🌐 Go | 📅 2026-03-30 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,561 | 🐛 299 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 826 | 🐛 63 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 156 | 🐛 1 | 🌐 Rust | 📅 2026-04-05 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,199 | 🐛 159 | 🌐 C | 📅 2026-04-06 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,544 | 🐛 114 | 🌐 Go | 📅 2026-04-03 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,479 | 🐛 351 | 🌐 Go | 📅 2026-04-01 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,003 | 🐛 170 | 🌐 Go | 📅 2026-04-05 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
* [Check\_postgres](https://github.com/bucardo/check_postgres) ⭐ 594 | 🐛 101 | 🌐 Perl | 📅 2025-01-02 - Nagios check\_postgres plugin for checking status of PostgreSQL databases.
...
* [pg\_ash](https://github.com/NikolayS/pg_ash) ⭐ 209 | 🐛 4 | 🌐 PLpgSQL | 📅 2026-04-06 - Active Session History for PostgreSQL. Samples pg\_stat\_activity once per second via pg\_cron, stores encoded snapshots, and provides 32 SQL functions for wait event analysis. Pure SQL, no extensions, works on managed providers (RDS, Cloud SQL, Supabase, etc.).
* [check\_pgactivity](https://github.com/OPMDG/check_pgactivity) ⭐ 181 | 🐛 57 | 🌐 Perl | 📅 2026-04-01 - check\_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,415 | 🐛 1,059 | 🌐 C | 📅 2026-04-05 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,632 | 🐛 165 | 🌐 Rust | 📅 2026-04-05 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,632 | 🐛 165 | 🌐 Rust | 📅 2026-04-05 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,371 | 🐛 200 | 🌐 C | 📅 2026-03-26 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,724 | 🐛 135 | 🌐 C | 📅 2026-04-02 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,653 | 🐛 49 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,786 | 🐛 69 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,625 | 🐛 5 | 🌐 C | 📅 2026-02-22 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,384 | 🐛 82 | 🌐 C++ | 📅 2026-03-06 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,211 | 🐛 185 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
* [pg\_shard](https://github.com/citusdata/pg_shard) ⭐ 1,062 | 🐛 38 | 🌐 C | 📅 2016-08-03 - Extension to scale out real-time reads and writes.
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 747 | 🐛 0 | 🌐 C | 📅 2026-03-18 - Extension that allows to check plpgsql source code.
* [pg\_squeeze](https://github.com/cybertec-postgresql/pg_squeeze) ⭐ 663 | 🐛 2 | 🌐 C | 📅 2025-10-08 - An extension for automatic bloat cleanup with minimal locking.
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 567 | 🐛 10 | 🌐 Perl | 📅 2026-04-02 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,980 | 🐛 48 | 🌐 Go | 📅 2026-04-05 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,731 | 🐛 39 | 🌐 PLpgSQL | 📅 2026-04-04 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,354 | 🐛 35 | 🌐 TypeScript | 📅 2026-03-30 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,445 | 🐛 68 | 🌐 TypeScript | 📅 2026-03-26 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,684 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-04 - Online version of PostgreSQL configuration wizard.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,932 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-04-02 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,725 | 🐛 386 | 🌐 Haskell | 📅 2026-04-03 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,918 | 🐛 151 | 🌐 TypeScript | 📅 2026-04-04 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,408 | 🐛 93 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,369 | 🐛 465 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,538 | 🐛 147 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,988 | 🐛 16 | 🌐 Perl | 📅 2026-02-21 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,441 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,121 | 🐛 77 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
* [migra](https://github.com/djrobstep/migra) ⭐ 3,050 | 🐛 86 | 🌐 Python | 📅 2025-08-25 - Like diff but for Postgres schemas.
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 3,007 | 🐛 13 | 🌐 Python | 📅 2026-01-13 - top like application for PostgreSQL server activity monitoring.
...
* [ZSON](https://github.com/postgrespro/zson) ⭐ 566 | 🐛 0 | 🌐 C | 📅 2023-04-14 - PostgreSQL extension for transparent JSONB compression
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 132 | 🐛 6 | 🌐 Python | 📅 2026-04-03 - Spot vulnerabilities in PostgreSQL extension scripts.
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 107 | 🐛 9 | 🌐 Rust | 📅 2026-04-05 - Linter for dangerous Postgres migration patterns in Diesel and SQLx.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 46 | 🐛 38 | 🌐 C# | 📅 2026-04-01 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,108 | 🐛 514 | 🌐 JavaScript | 📅 2026-04-02, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,549 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-02, [slonik](https://github.com/gajus/slonik) ⭐ 4,898 | 🐛 31 | 🌐 TypeScript | 📅 2026-03-13, [postgres](https://github.com/porsager/postgres) ⭐ 8,599 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,845 | 🐛 57 | 🌐 Go | 📅 2026-04-03, [pgx](https://github.com/jackc/pgx) ⭐ 13,579 | 🐛 244 | 🌐 Go | 📅 2026-04-03, [go-pg](https://github.com/go-pg/pg) ⭐ 5,786 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,921 | 🐛 153 | 🌐 Rust | 📅 2026-04-04, [pgx](https://github.com/tcdi/pgx) ⭐ 4,436 | 🐛 338 | 🌐 Rust | 📅 2026-03-27, [wtx](https://github.com/c410-f3r/wtx) ⭐ 346 | 🐛 13 | 🌐 Rust | 📅 2026-04-06
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,671 | 🐛 215 | 🌐 C# | 📅 2026-04-04
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 31 | 🌐 R | 📅 2026-03-23, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
* Clojure: [clj-postgresql](https://github.com/remodoy/clj-postgresql) ⭐ 162 | 🐛 9 | 🌐 Clojure | 📅 2025-03-07
* Lua: [luapgsql](https://github.com/arcapos/luapgsql) ⭐ 118 | 🐛 7 | 🌐 C | 📅 2026-02-07
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,357 | 🐛 324 | 🌐 Go | 📅 2026-04-04 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,133 | 🐛 566 | 🌐 Go | 📅 2026-03-26 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,387 | 🐛 157 | 🌐 Go | 📅 2026-03-25 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,383 | 🐛 1 | 🌐 Java | 📅 2026-03-24 -  Full Stack PostgreSQL on Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,460 | 🐛 89 | 🌐 HTML | 📅 2026-04-03
