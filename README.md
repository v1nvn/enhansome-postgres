# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,521 | 🐛 75 | 📅 2026-03-09 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,222 | 🐛 72 | 🌐 Python | 📅 2026-03-05 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,015 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-10 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 681 | 🐛 30 | 🌐 C | 📅 2026-03-11 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,960 | 🐛 332 | 🌐 Go | 📅 2026-03-09 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,402 | 🐛 54 | 🌐 Python | 📅 2026-03-10 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,269 | 🐛 742 | 🌐 Python | 📅 2026-03-02 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,006 | 🐛 147 | 🌐 TypeScript | 📅 2026-03-11 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 991 | 🐛 50 | 🌐 PLpgSQL | 📅 2026-03-10 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,065 | 🐛 59 | 🌐 Python | 📅 2026-02-22 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,152 | 🐛 246 | 🌐 Go | 📅 2026-03-08 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,553 | 🐛 297 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [pgplan](https://github.com/JacobArthurs/pgplan) ⭐ 9 | 🐛 0 | 🌐 Go | 📅 2026-03-10 - compare and analyze PostgreSQL EXPLAIN plans from the CLI
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,191 | 🐛 165 | 🌐 C | 📅 2026-03-11 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,462 | 🐛 112 | 🌐 Go | 📅 2026-03-10 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 984 | 🐛 175 | 🌐 Go | 📅 2026-03-10 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,360 | 🐛 1,045 | 🌐 C | 📅 2026-03-10 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,513 | 🐛 120 | 🌐 Rust | 📅 2026-03-11 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,513 | 🐛 120 | 🌐 Rust | 📅 2026-03-11 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,283 | 🐛 180 | 🌐 C | 📅 2026-03-03 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,692 | 🐛 133 | 🌐 C | 📅 2026-02-23 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,623 | 🐛 45 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,377 | 🐛 71 | 🌐 C++ | 📅 2026-03-06 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 743 | 🐛 0 | 🌐 C | 📅 2026-02-18 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 559 | 🐛 8 | 🌐 Perl | 📅 2026-03-10 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,867 | 🐛 44 | 🌐 Go | 📅 2026-03-09 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,607 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-03-05 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,279 | 🐛 36 | 🌐 TypeScript | 📅 2026-03-11 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,804 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,415 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-09 - Online Postgres Explain Visualizer.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,637 | 🐛 384 | 🌐 Haskell | 📅 2026-03-10 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,912 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-11 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,377 | 🐛 91 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,333 | 🐛 464 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 46 | 🐛 33 | 🌐 C# | 📅 2026-03-11 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,084 | 🐛 511 | 🌐 JavaScript | 📅 2026-03-07, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,549 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-28, [slonik](https://github.com/gajus/slonik) ⭐ 4,892 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-05, [postgres](https://github.com/porsager/postgres) ⭐ 8,582 | 🐛 252 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,820 | 🐛 70 | 🌐 Go | 📅 2026-03-11, [pgx](https://github.com/jackc/pgx) ⭐ 13,576 | 🐛 250 | 🌐 Go | 📅 2026-03-09, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,915 | 🐛 151 | 🌐 Rust | 📅 2026-02-27, [pgx](https://github.com/tcdi/pgx) ⭐ 4,385 | 🐛 338 | 🌐 Rust | 📅 2026-03-08, [wtx](https://github.com/c410-f3r/wtx) ⭐ 344 | 🐛 13 | 🌐 Rust | 📅 2026-03-09
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,661 | 🐛 244 | 🌐 C# | 📅 2026-03-11
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,398 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,202 | 🐛 6 | 🌐 Elixir | 📅 2026-03-09
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 31 | 🌐 R | 📅 2026-03-11, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,185 | 🐛 309 | 🌐 Go | 📅 2026-03-11 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,376 | 🐛 152 | 🌐 Go | 📅 2026-03-11 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 356 | 🐛 33 | 🌐 Go | 📅 2026-03-10 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,433 | 🐛 88 | 🌐 PLpgSQL | 📅 2026-03-10
