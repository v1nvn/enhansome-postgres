# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,493 | 🐛 70 | 📅 2026-01-28 with stars
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,921 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-14 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 671 | 🐛 19 | 🌐 C | 📅 2026-02-14 - 100% open-source logical multi-master PostgreSQL replication.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,221 | 🐛 739 | 🌐 Python | 📅 2026-02-13 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 20,868 | 🐛 162 | 🌐 TypeScript | 📅 2026-02-13 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [atlas](https://github.com/ariga/atlas) ⭐ 8,082 | 🐛 241 | 🌐 Go | 📅 2026-02-07 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,386 | 🐛 118 | 🌐 Go | 📅 2026-02-12 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 965 | 🐛 171 | 🌐 Go | 📅 2026-02-14 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,287 | 🐛 1,050 | 🌐 C | 📅 2026-02-13 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,335 | 🐛 113 | 🌐 Rust | 📅 2026-02-15 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,335 | 🐛 113 | 🌐 Rust | 📅 2026-02-15 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,225 | 🐛 178 | 🌐 C | 📅 2026-02-14 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,661 | 🐛 128 | 🌐 C | 📅 2025-12-22 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,596 | 🐛 53 | 🌐 PLpgSQL | 📅 2026-02-09 - Partition management extension for PostgreSQL.
...
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,199 | 🐛 186 | 🌐 C | 📅 2026-02-14 - Extension that provides logical streaming replication.
* [pg\_shard](https://github.com/citusdata/pg_shard) ⭐ 1,062 | 🐛 38 | 🌐 C | 📅 2016-08-03 - Extension to scale out real-time reads and writes.
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 738 | 🐛 3 | 🌐 C | 📅 2026-02-14 - Extension that allows to check plpgsql source code.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,816 | 🐛 45 | 🌐 Go | 📅 2026-02-13 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,525 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-02-14 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,199 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-15 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,789 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,355 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-02 - Online Postgres Explain Visualizer.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,516 | 🐛 381 | 🌐 Haskell | 📅 2026-02-13 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-13 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,276 | 🐛 91 | 🌐 Go | 📅 2026-02-03 - Zero-downtime, reversible, schema migrations for Postgres
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,062 | 🐛 498 | 🌐 JavaScript | 📅 2026-02-13, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,549 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-04, [slonik](https://github.com/gajus/slonik) ⭐ 4,885 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-12, [postgres](https://github.com/porsager/postgres) ⭐ 8,548 | 🐛 250 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,793 | 🐛 84 | 🌐 Go | 📅 2026-02-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,326 | 🐛 251 | 🌐 Go | 📅 2026-02-15, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,902 | 🐛 148 | 🌐 Rust | 📅 2026-02-03, [pgx](https://github.com/tcdi/pgx) ⭐ 4,363 | 🐛 333 | 🌐 Rust | 📅 2026-02-09, [wtx](https://github.com/c410-f3r/wtx) ⭐ 342 | 🐛 12 | 🌐 Rust | 📅 2026-02-11
...
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,200 | 🐛 6 | 🌐 Elixir | 📅 2026-02-01
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 854 | 🐛 16 | 🌐 C | 📅 2026-02-12
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 487 | 🐛 4 | 🌐 Zig | 📅 2026-02-14
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,019 | 🐛 310 | 🌐 Go | 📅 2026-02-15 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,361 | 🐛 1 | 🌐 Java | 📅 2026-02-13 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 355 | 🐛 31 | 🌐 Go | 📅 2026-02-13 - Percona Operator for PostgreSQL based on Crunchy Data operator.
