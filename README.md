# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 456,406 | 🐛 65 | 📅 2026-04-02 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,834 | 🐛 29 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,834 | 🐛 29 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,360 | 🐛 63 | 🌐 Python | 📅 2026-04-13 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,121 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-15 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 90 | 🐛 43 | 🌐 Go | 📅 2026-04-17 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,005 | 🐛 334 | 🌐 Go | 📅 2026-04-15 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,484 | 🐛 749 | 🌐 Python | 📅 2026-04-13 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,132 | 🐛 172 | 🌐 TypeScript | 📅 2026-04-17 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 1,002 | 🐛 52 | 🌐 PLpgSQL | 📅 2026-04-10 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,988 | 🐛 21 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,111 | 🐛 60 | 🌐 Python | 📅 2026-04-18 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,292 | 🐛 256 | 🌐 Go | 📅 2026-04-14 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 163 | 🐛 1 | 🌐 Rust | 📅 2026-04-17 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,568 | 🐛 111 | 🌐 Go | 📅 2026-04-15 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,001 | 🐛 180 | 🌐 Go | 📅 2026-04-18 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [pg\_exporter](https://github.com/Vonng/pg_exporter) ⭐ 341 | 🐛 13 | 🌐 Go | 📅 2026-04-14 - Fully customizable Prometheus exporter for PostgreSQL & Pgbouncer with fine-grained execution control.
* [pg\_ash](https://github.com/NikolayS/pg_ash) ⭐ 218 | 🐛 5 | 🌐 PLpgSQL | 📅 2026-04-17 - Active Session History for PostgreSQL. Samples pg\_stat\_activity once per second via pg\_cron, stores encoded snapshots, and provides 32 SQL functions for wait event analysis. Pure SQL, no extensions, works on managed providers (RDS, Cloud SQL, Supabase, etc.).
...
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,668 | 🐛 156 | 🌐 Rust | 📅 2026-04-18 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,668 | 🐛 156 | 🌐 Rust | 📅 2026-04-18 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,431 | 🐛 214 | 🌐 C | 📅 2026-04-16 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,747 | 🐛 135 | 🌐 C | 📅 2026-04-07 - Run periodic jobs in PostgreSQL.
...
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,630 | 🐛 5 | 🌐 C | 📅 2026-02-22 - HypoPG provides hypothetical/virtual indexes feature.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,033 | 🐛 47 | 🌐 Go | 📅 2026-04-17 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,780 | 🐛 41 | 🌐 PLpgSQL | 📅 2026-04-16 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,394 | 🐛 45 | 🌐 TypeScript | 📅 2026-04-16 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,833 | 🐛 15 | 🌐 Ruby | 📅 2026-04-15 - PostgreSQL insights made easy.
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,455 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-07 - Online Postgres Explain Visualizer.
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,693 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-08 - Online version of PostgreSQL configuration wizard.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,946 | 🐛 385 | 🌐 Haskell | 📅 2026-04-17 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,435 | 🐛 94 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
...
* [ZSON](https://github.com/postgrespro/zson) ⭐ 567 | 🐛 0 | 🌐 C | 📅 2023-04-14 - PostgreSQL extension for transparent JSONB compression
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,111 | 🐛 519 | 🌐 JavaScript | 📅 2026-04-17, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,551 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,900 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,608 | 🐛 254 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,851 | 🐛 50 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,645 | 🐛 251 | 🌐 Go | 📅 2026-04-11, [go-pg](https://github.com/go-pg/pg) ⭐ 5,783 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,925 | 🐛 158 | 🌐 Rust | 📅 2026-04-14, [pgx](https://github.com/tcdi/pgx) ⭐ 4,455 | 🐛 332 | 🌐 Rust | 📅 2026-04-17, [wtx](https://github.com/c410-f3r/wtx) ⭐ 350 | 🐛 13 | 🌐 Rust | 📅 2026-04-16
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 525 | 🐛 4 | 🌐 Zig | 📅 2026-04-14
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,458 | 🐛 337 | 🌐 Go | 📅 2026-04-18 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,468 | 🐛 95 | 🌐 HTML | 📅 2026-04-18
