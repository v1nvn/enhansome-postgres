# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,158 | 🐛 73 | 📅 2026-05-03 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,399 | 🐛 65 | 🌐 Python | 📅 2026-04-24 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,162 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-02 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 705 | 🐛 26 | 🌐 C | 📅 2026-05-04 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,057 | 🐛 343 | 🌐 Go | 📅 2026-05-04 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,576 | 🐛 94 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,410 | 🐛 53 | 🌐 Python | 📅 2026-03-11 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 1,006 | 🐛 55 | 🌐 PLpgSQL | 📅 2026-04-30 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,066 | 🐛 23 | 🌐 Shell | 📅 2026-05-03 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,141 | 🐛 62 | 🌐 Python | 📅 2026-05-03 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,349 | 🐛 256 | 🌐 Go | 📅 2026-04-20 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 844 | 🐛 66 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,214 | 🐛 167 | 🌐 C | 📅 2026-05-04 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,611 | 🐛 111 | 🌐 Go | 📅 2026-04-30 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,506 | 🐛 353 | 🌐 Go | 📅 2026-05-01 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,016 | 🐛 177 | 🌐 Go | 📅 2026-05-04 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [pg\_ash](https://github.com/NikolayS/pg_ash) ⭐ 221 | 🐛 1 | 🌐 PLpgSQL | 📅 2026-05-01 - Active Session History for PostgreSQL. Samples pg\_stat\_activity once per second via pg\_cron, stores encoded snapshots, and provides 32 SQL functions for wait event analysis. Pure SQL, no extensions, works on managed providers (RDS, Cloud SQL, Supabase, etc.).
* [check\_pgactivity](https://github.com/OPMDG/check_pgactivity) ⭐ 181 | 🐛 48 | 🌐 Perl | 📅 2026-05-03 - check\_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,463 | 🐛 1,061 | 🌐 C | 📅 2026-05-01 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,723 | 🐛 172 | 🌐 Rust | 📅 2026-05-04 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,723 | 🐛 172 | 🌐 Rust | 📅 2026-05-04 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,472 | 🐛 203 | 🌐 C | 📅 2026-04-30 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,767 | 🐛 133 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,689 | 🐛 52 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,393 | 🐛 72 | 🌐 C++ | 📅 2026-05-01 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 575 | 🐛 8 | 🌐 Perl | 📅 2026-04-29 - Query Performance Monitoring tool for PostgreSQL.
...
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,828 | 🐛 40 | 🌐 PLpgSQL | 📅 2026-04-29 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,475 | 🐛 41 | 🌐 TypeScript | 📅 2026-05-02 - Queueing jobs in Postgres from Node.js like a boss.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,967 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-05-01 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,064 | 🐛 377 | 🌐 Haskell | 📅 2026-05-03 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,918 | 🐛 154 | 🌐 TypeScript | 📅 2026-04-28 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
...
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 4,003 | 🐛 16 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 47 | 🐛 32 | 🌐 C# | 📅 2026-05-03 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,123 | 🐛 523 | 🌐 JavaScript | 📅 2026-04-30, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,551 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,900 | 🐛 33 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,633 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,871 | 🐛 49 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,733 | 🐛 250 | 🌐 Go | 📅 2026-04-25, [go-pg](https://github.com/go-pg/pg) ⭐ 5,784 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,934 | 🐛 163 | 🌐 Rust | 📅 2026-04-23, [pgx](https://github.com/tcdi/pgx) ⭐ 4,657 | 🐛 333 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 354 | 🐛 9 | 🌐 Rust | 📅 2026-05-02
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,680 | 🐛 208 | 🌐 C# | 📅 2026-05-03
...
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 32 | 🌐 R | 📅 2026-05-04, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,556 | 🐛 368 | 🌐 Go | 📅 2026-05-03 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,400 | 🐛 162 | 🌐 Go | 📅 2026-04-29 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,392 | 🐛 1 | 🌐 Java | 📅 2026-04-30 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 364 | 🐛 33 | 🌐 Go | 📅 2026-05-03 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,474 | 🐛 104 | 🌐 HTML | 📅 2026-05-03
