# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 473,026 | 🐛 83 | 📅 2026-06-02 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,941 | 🐛 40 | 📅 2026-05-21 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,941 | 🐛 40 | 📅 2026-05-21 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,485 | 🐛 59 | 🌐 Python | 📅 2026-05-28 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,244 | 🐛 27 | 🌐 TypeScript | 📅 2026-06-04 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 727 | 🐛 29 | 🌐 C | 📅 2026-06-04 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,588 | 🐛 95 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Teable](https://github.com/teableio/teable) ⭐ 21,303 | 🐛 187 | 🌐 TypeScript | 📅 2026-06-05 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,369 | 🐛 52 | 🌐 Go | 📅 2026-06-03 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,625 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 1,010 | 🐛 71 | 🌐 PLpgSQL | 📅 2026-06-04 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,199 | 🐛 39 | 🌐 Python | 📅 2026-06-03 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,453 | 🐛 258 | 🌐 Go | 📅 2026-06-04 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,222 | 🐛 202 | 🌐 C | 📅 2026-06-05 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,699 | 🐛 114 | 🌐 Go | 📅 2026-06-03 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,035 | 🐛 193 | 🌐 Go | 📅 2026-06-05 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,538 | 🐛 1,044 | 🌐 C | 📅 2026-06-04 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,901 | 🐛 164 | 🌐 Rust | 📅 2026-06-05 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,901 | 🐛 164 | 🌐 Rust | 📅 2026-06-05 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,572 | 🐛 195 | 🌐 C | 📅 2026-06-03 - Adds fully-functional graph database support including Cypher queries.
...
* [pg\_squeeze](https://github.com/cybertec-postgresql/pg_squeeze) ⭐ 671 | 🐛 2 | 🌐 C | 📅 2025-10-08 - An extension for automatic bloat cleanup with minimal locking.
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 579 | 🐛 15 | 🌐 Perl | 📅 2026-06-04 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,185 | 🐛 57 | 🌐 Go | 📅 2026-06-04 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,931 | 🐛 38 | 🌐 PLpgSQL | 📅 2026-05-20 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,594 | 🐛 52 | 🌐 TypeScript | 📅 2026-06-04 - Queueing jobs in Postgres from Node.js like a boss.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,976 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-06-04 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,199 | 🐛 383 | 🌐 Haskell | 📅 2026-06-04 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,489 | 🐛 93 | 🌐 Go | 📅 2026-06-03 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pg\_activity](https://github.com/dalibo/pg_activity) ⭐ 3,018 | 🐛 16 | 🌐 Python | 📅 2026-06-02 - top like application for PostgreSQL server activity monitoring.
...
* [pg-spot-operator](https://github.com/pg-spot-ops/pg-spot-operator) ⭐ 59 | 🐛 20 | 🌐 Python | 📅 2026-06-04 - A daemon to run stateful Postgres on cheap AWS Spot VMs
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 47 | 🐛 34 | 🌐 C# | 📅 2026-06-04 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,148 | 🐛 512 | 🌐 JavaScript | 📅 2026-06-02, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,553 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,902 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-03, [postgres](https://github.com/porsager/postgres) ⭐ 8,654 | 🐛 259 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,899 | 🐛 52 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,888 | 🐛 245 | 🌐 Go | 📅 2026-06-03, [go-pg](https://github.com/go-pg/pg) ⭐ 5,789 | 🐛 121 | 🌐 Go | 📅 2026-05-29
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,938 | 🐛 171 | 🌐 Rust | 📅 2026-05-28, [pgx](https://github.com/tcdi/pgx) ⭐ 4,695 | 🐛 334 | 🌐 Rust | 📅 2026-06-05, [wtx](https://github.com/c410-f3r/wtx) ⭐ 358 | 🐛 9 | 🌐 Rust | 📅 2026-06-05
...
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 870 | 🐛 34 | 🌐 C | 📅 2026-06-05
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,741 | 🐛 379 | 🌐 Go | 📅 2026-06-04 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,176 | 🐛 560 | 🌐 Go | 📅 2026-06-04 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,413 | 🐛 163 | 🌐 Go | 📅 2026-06-04 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,406 | 🐛 1 | 🌐 Java | 📅 2026-06-04 -  Full Stack PostgreSQL on Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 374 | 🐛 42 | 🌐 Go | 📅 2026-06-04 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,496 | 🐛 114 | 🌐 HTML | 📅 2026-06-05
