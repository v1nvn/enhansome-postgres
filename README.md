# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,300 | 🐛 88 | 📅 2026-03-09 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,800 | 🐛 22 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,800 | 🐛 22 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,298 | 🐛 64 | 🌐 Python | 📅 2026-03-26 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,091 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-30 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [repmgr](https://github.com/2ndQuadrant/repmgr) ⭐ 1,685 | 🐛 129 | 🌐 C | 📅 2026-03-28 - Open-source tool suite to manage replication and failover in a cluster of PostgreSQL servers.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 688 | 🐛 31 | 🌐 C | 📅 2026-03-31 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 86 | 🐛 35 | 🌐 Go | 📅 2026-03-31 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,985 | 🐛 337 | 🌐 Go | 📅 2026-03-30 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,536 | 🐛 93 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,312 | 🐛 742 | 🌐 Python | 📅 2026-03-29 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,066 | 🐛 156 | 🌐 TypeScript | 📅 2026-03-31 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,280 | 🐛 44 | 🌐 Go | 📅 2026-03-01 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,952 | 🐛 19 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,087 | 🐛 61 | 🌐 Python | 📅 2026-03-25 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,227 | 🐛 254 | 🌐 Go | 📅 2026-03-30 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 823 | 🐛 62 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 151 | 🐛 2 | 🌐 Rust | 📅 2026-03-30 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,195 | 🐛 158 | 🌐 C | 📅 2026-03-30 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,469 | 🐛 347 | 🌐 Go | 📅 2026-03-04 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 996 | 🐛 177 | 🌐 Go | 📅 2026-03-31 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,405 | 🐛 1,059 | 🌐 C | 📅 2026-03-30 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,608 | 🐛 162 | 🌐 Rust | 📅 2026-03-31 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,608 | 🐛 162 | 🌐 Rust | 📅 2026-03-31 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,355 | 🐛 189 | 🌐 C | 📅 2026-03-26 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,717 | 🐛 132 | 🌐 C | 📅 2026-03-12 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,648 | 🐛 49 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 746 | 🐛 0 | 🌐 C | 📅 2026-03-18 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 564 | 🐛 13 | 🌐 Perl | 📅 2026-03-30 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,958 | 🐛 47 | 🌐 Go | 📅 2026-03-30 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,712 | 🐛 39 | 🌐 PLpgSQL | 📅 2026-03-31 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,343 | 🐛 34 | 🌐 TypeScript | 📅 2026-03-30 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,825 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
...
* [TimescaleDB Tune](https://github.com/timescale/timescaledb-tune) ⭐ 495 | 🐛 17 | 🌐 Go | 📅 2025-12-23 - a program for tuning a TimescaleDB database to perform its best based on the host's resources such as memory and number of CPUs.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,924 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-03-30 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,705 | 🐛 389 | 🌐 Haskell | 📅 2026-03-30 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,406 | 🐛 92 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,364 | 🐛 465 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,536 | 🐛 147 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,984 | 🐛 15 | 🌐 Perl | 📅 2026-02-21 - Fast PostgreSQL Log Analyzer.
...
* [pg\_chameleon](https://github.com/the4thdoctor/pg_chameleon) ⭐ 432 | 🐛 46 | 🌐 Python | 📅 2025-01-21 - Real time replica from MySQL to PostgreSQL with optional type override migration and migration capabilities.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 131 | 🐛 5 | 🌐 Python | 📅 2026-03-21 - Spot vulnerabilities in PostgreSQL extension scripts.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 46 | 🐛 38 | 🌐 C# | 📅 2026-03-27 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,102 | 🐛 508 | 🌐 JavaScript | 📅 2026-03-07, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,546 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-26, [slonik](https://github.com/gajus/slonik) ⭐ 4,895 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-13, [postgres](https://github.com/porsager/postgres) ⭐ 8,596 | 🐛 251 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,839 | 🐛 61 | 🌐 Go | 📅 2026-03-30, [pgx](https://github.com/jackc/pgx) ⭐ 13,543 | 🐛 243 | 🌐 Go | 📅 2026-03-28, [go-pg](https://github.com/go-pg/pg) ⭐ 5,785 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,920 | 🐛 152 | 🌐 Rust | 📅 2026-03-30, [pgx](https://github.com/tcdi/pgx) ⭐ 4,428 | 🐛 337 | 🌐 Rust | 📅 2026-03-27, [wtx](https://github.com/c410-f3r/wtx) ⭐ 346 | 🐛 13 | 🌐 Rust | 📅 2026-03-31
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,670 | 🐛 212 | 🌐 C# | 📅 2026-03-25
* TypeScript: [zapatos](https://github.com/jawj/zapatos) ⭐ 1,399 | 🐛 51 | 🌐 TypeScript | 📅 2025-09-19
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 519 | 🐛 4 | 🌐 Zig | 📅 2026-02-23
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,329 | 🐛 323 | 🌐 Go | 📅 2026-03-31 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,125 | 🐛 566 | 🌐 Go | 📅 2026-03-26 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 358 | 🐛 27 | 🌐 Go | 📅 2026-03-31 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,440 | 🐛 88 | 🌐 PLpgSQL | 📅 2026-03-31
