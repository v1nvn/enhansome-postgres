# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,260 | 🐛 69 | 📅 2026-01-28 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,683 | 🐛 21 | 📅 2026-01-05 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,683 | 🐛 21 | 📅 2026-01-05 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,155 | 🐛 75 | 🌐 Python | 📅 2026-01-29 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,920 | 🐛 34 | 🌐 TypeScript | 📅 2026-02-09 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 670 | 🐛 19 | 🌐 C | 📅 2026-02-14 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,394 | 🐛 55 | 🌐 Python | 📅 2026-02-13 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,220 | 🐛 739 | 🌐 Python | 📅 2026-02-13 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 20,868 | 🐛 164 | 🌐 TypeScript | 📅 2026-02-13 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,255 | 🐛 41 | 🌐 Go | 📅 2026-02-01 - Web-based PostgreSQL database browser written in Go.
...
* [atlas](https://github.com/ariga/atlas) ⭐ 8,081 | 🐛 240 | 🌐 Go | 📅 2026-02-07 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 796 | 🐛 57 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,187 | 🐛 164 | 🌐 C | 📅 2026-02-13 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,385 | 🐛 117 | 🌐 Go | 📅 2026-02-12 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 965 | 🐛 170 | 🌐 Go | 📅 2026-02-13 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,287 | 🐛 1,049 | 🌐 C | 📅 2026-02-13 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,333 | 🐛 113 | 🌐 Rust | 📅 2026-02-13 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,333 | 🐛 113 | 🌐 Rust | 📅 2026-02-13 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,223 | 🐛 179 | 🌐 C | 📅 2026-02-13 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,660 | 🐛 128 | 🌐 C | 📅 2025-12-22 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,596 | 🐛 52 | 🌐 PLpgSQL | 📅 2026-02-09 - Partition management extension for PostgreSQL.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 738 | 🐛 3 | 🌐 C | 📅 2026-02-13 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 555 | 🐛 8 | 🌐 Perl | 📅 2026-02-13 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,812 | 🐛 45 | 🌐 Go | 📅 2026-02-13 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,521 | 🐛 42 | 🌐 PLpgSQL | 📅 2026-02-08 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,197 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-13 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,354 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-02 - Online Postgres Explain Visualizer.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,898 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-12 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,515 | 🐛 381 | 🌐 Haskell | 📅 2026-02-13 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,276 | 🐛 92 | 🌐 Go | 📅 2026-02-03 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,317 | 🐛 2 | 🌐 Go | 📅 2026-02-13 - Advanced job scheduler for PostgreSQL.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,061 | 🐛 498 | 🌐 JavaScript | 📅 2026-02-13, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,549 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-04, [slonik](https://github.com/gajus/slonik) ⭐ 4,885 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-12, [postgres](https://github.com/porsager/postgres) ⭐ 8,547 | 🐛 250 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,793 | 🐛 84 | 🌐 Go | 📅 2026-02-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,324 | 🐛 256 | 🌐 Go | 📅 2026-02-11, [go-pg](https://github.com/go-pg/pg) ⭐ 5,786 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,901 | 🐛 148 | 🌐 Rust | 📅 2026-02-03, [pgx](https://github.com/tcdi/pgx) ⭐ 4,362 | 🐛 333 | 🌐 Rust | 📅 2026-02-09, [wtx](https://github.com/c410-f3r/wtx) ⭐ 342 | 🐛 12 | 🌐 Rust | 📅 2026-02-11
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 486 | 🐛 3 | 🌐 Zig | 📅 2026-02-14
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,012 | 🐛 300 | 🌐 Go | 📅 2026-02-14 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,083 | 🐛 555 | 🌐 Go | 📅 2026-02-13 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,365 | 🐛 145 | 🌐 Go | 📅 2026-02-13 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,360 | 🐛 1 | 🌐 Java | 📅 2026-02-13 -  Full Stack PostgreSQL on Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,427 | 🐛 64 | 🌐 PLpgSQL | 📅 2026-02-13
