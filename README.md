# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,916 | 🐛 71 | 📅 2026-01-28 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,160 | 🐛 71 | 🌐 Python | 📅 2026-01-29 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 3,927 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-16 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,326 | 🐛 121 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 671 | 🐛 21 | 🌐 C | 📅 2026-02-16 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pghoard](https://github.com/aiven/pghoard) ⭐ 1,395 | 🐛 55 | 🌐 Python | 📅 2026-02-16 - Backup and restore tool for cloud object stores (AWS S3, Azure, Google Cloud, OpenStack Swift).
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,226 | 🐛 738 | 🌐 Python | 📅 2026-02-16 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 20,876 | 🐛 162 | 🌐 TypeScript | 📅 2026-02-13 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 982 | 🐛 49 | 🌐 PLpgSQL | 📅 2026-02-16 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,024 | 🐛 59 | 🌐 Python | 📅 2026-01-17 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,085 | 🐛 241 | 🌐 Go | 📅 2026-02-07 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 797 | 🐛 56 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,187 | 🐛 166 | 🌐 C | 📅 2026-02-16 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,388 | 🐛 118 | 🌐 Go | 📅 2026-02-12 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 965 | 🐛 172 | 🌐 Go | 📅 2026-02-17 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,293 | 🐛 1,050 | 🌐 C | 📅 2026-02-16 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,343 | 🐛 112 | 🌐 Rust | 📅 2026-02-16 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,343 | 🐛 112 | 🌐 Rust | 📅 2026-02-16 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,229 | 🐛 178 | 🌐 C | 📅 2026-02-16 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,662 | 🐛 129 | 🌐 C | 📅 2025-12-22 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,599 | 🐛 55 | 🌐 PLpgSQL | 📅 2026-02-16 - Partition management extension for PostgreSQL.
...
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,370 | 🐛 73 | 🌐 C++ | 📅 2026-02-07 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,821 | 🐛 41 | 🌐 Go | 📅 2026-02-16 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,537 | 🐛 43 | 🌐 PLpgSQL | 📅 2026-02-17 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,208 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-16 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,792 | 🐛 15 | 🌐 Ruby | 📅 2025-12-26 - PostgreSQL insights made easy.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,898 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-17 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,520 | 🐛 380 | 🌐 Haskell | 📅 2026-02-16 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,287 | 🐛 464 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,277 | 🐛 90 | 🌐 Go | 📅 2026-02-16 - Zero-downtime, reversible, schema migrations for Postgres
* [pREST](https://github.com/prest/prest) ⭐ 4,519 | 🐛 147 | 🌐 Go | 📅 2026-02-11 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,948 | 🐛 16 | 🌐 Perl | 📅 2026-02-05 - Fast PostgreSQL Log Analyzer.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,319 | 🐛 2 | 🌐 Go | 📅 2026-02-13 - Advanced job scheduler for PostgreSQL.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,065 | 🐛 498 | 🌐 JavaScript | 📅 2026-02-13, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,549 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-04, [slonik](https://github.com/gajus/slonik) ⭐ 4,887 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-16, [postgres](https://github.com/porsager/postgres) ⭐ 8,555 | 🐛 250 | 🌐 JavaScript | 📅 2026-01-06
* Go: [pq](https://github.com/lib/pq) ⭐ 9,793 | 🐛 84 | 🌐 Go | 📅 2026-02-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,335 | 🐛 252 | 🌐 Go | 📅 2026-02-15, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,903 | 🐛 148 | 🌐 Rust | 📅 2026-02-03, [pgx](https://github.com/tcdi/pgx) ⭐ 4,364 | 🐛 333 | 🌐 Rust | 📅 2026-02-09, [wtx](https://github.com/c410-f3r/wtx) ⭐ 342 | 🐛 12 | 🌐 Rust | 📅 2026-02-11
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,653 | 🐛 233 | 🌐 C# | 📅 2026-02-17
...
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 488 | 🐛 4 | 🌐 Zig | 📅 2026-02-15
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,027 | 🐛 315 | 🌐 Go | 📅 2026-02-17 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,086 | 🐛 554 | 🌐 Go | 📅 2026-02-16 - Creates and manages PostgreSQL clusters running in Kubernetes.
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,367 | 🐛 145 | 🌐 Go | 📅 2026-02-16 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
...
* [Percona PostgreSQL Operator](https://github.com/percona/percona-postgresql-operator) ⭐ 355 | 🐛 40 | 🌐 Go | 📅 2026-02-17 - Percona Operator for PostgreSQL based on Crunchy Data operator.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,428 | 🐛 69 | 🌐 PLpgSQL | 📅 2026-02-13
