# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 456,114 | 🐛 64 | 📅 2026-04-02 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,832 | 🐛 28 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,832 | 🐛 28 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,357 | 🐛 62 | 🌐 Python | 📅 2026-04-13 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,120 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-15 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,339 | 🐛 125 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 698 | 🐛 26 | 🌐 C | 📅 2026-04-17 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 90 | 🐛 39 | 🌐 Go | 📅 2026-04-17 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,557 | 🐛 94 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,466 | 🐛 748 | 🌐 Python | 📅 2026-04-13 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,125 | 🐛 167 | 🌐 TypeScript | 📅 2026-04-17 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [temBoard](https://github.com/dalibo/temboard) ⭐ 759 | 🐛 86 | 🌐 Python | 📅 2026-04-16 - Web-based PostgreSQL GUI and monitoring.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,987 | 🐛 21 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,108 | 🐛 66 | 🌐 Python | 📅 2026-04-01 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,290 | 🐛 256 | 🌐 Go | 📅 2026-04-14 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [pg-schema-diff](https://github.com/stripe/pg-schema-diff) ⭐ 834 | 🐛 63 | 🌐 Go | 📅 2026-01-07 - CLI (and Golang library) for diffing Postgres schemas and generating SQL migrations with minimal locking.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 162 | 🐛 1 | 🌐 Rust | 📅 2026-04-17 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,201 | 🐛 165 | 🌐 C | 📅 2026-04-16 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,491 | 🐛 352 | 🌐 Go | 📅 2026-04-16 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,001 | 🐛 178 | 🌐 Go | 📅 2026-04-17 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,429 | 🐛 1,066 | 🌐 C | 📅 2026-04-16 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,665 | 🐛 152 | 🌐 Rust | 📅 2026-04-17 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,665 | 🐛 152 | 🌐 Rust | 📅 2026-04-17 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,426 | 🐛 214 | 🌐 C | 📅 2026-04-16 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,746 | 🐛 135 | 🌐 C | 📅 2026-04-07 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,666 | 🐛 50 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,785 | 🐛 70 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,628 | 🐛 5 | 🌐 C | 📅 2026-02-22 - HypoPG provides hypothetical/virtual indexes feature.
...
* [pglogical](https://github.com/2ndQuadrant/pglogical) ⭐ 1,211 | 🐛 184 | 🌐 C | 📅 2026-02-28 - Extension that provides logical streaming replication.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,028 | 🐛 47 | 🌐 Go | 📅 2026-04-16 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,774 | 🐛 41 | 🌐 PLpgSQL | 📅 2026-04-16 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,389 | 🐛 45 | 🌐 TypeScript | 📅 2026-04-16 - Queueing jobs in Postgres from Node.js like a boss.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,947 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-04-16 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,933 | 🐛 384 | 🌐 Haskell | 📅 2026-04-16 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,432 | 🐛 94 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
...
* [pREST](https://github.com/prest/prest) ⭐ 4,544 | 🐛 147 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 3,995 | 🐛 16 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,442 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,109 | 🐛 519 | 🌐 JavaScript | 📅 2026-04-13, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,551 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,899 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,608 | 🐛 254 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,852 | 🐛 50 | 🌐 Go | 📅 2026-04-08, [pgx](https://github.com/jackc/pgx) ⭐ 13,643 | 🐛 249 | 🌐 Go | 📅 2026-04-11, [go-pg](https://github.com/go-pg/pg) ⭐ 5,784 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,925 | 🐛 157 | 🌐 Rust | 📅 2026-04-14, [pgx](https://github.com/tcdi/pgx) ⭐ 4,452 | 🐛 333 | 🌐 Rust | 📅 2026-04-16, [wtx](https://github.com/c410-f3r/wtx) ⭐ 350 | 🐛 13 | 🌐 Rust | 📅 2026-04-16
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,446 | 🐛 347 | 🌐 Go | 📅 2026-04-17 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,145 | 🐛 571 | 🌐 Go | 📅 2026-04-16 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,467 | 🐛 90 | 🌐 HTML | 📅 2026-04-16
