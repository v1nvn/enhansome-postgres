# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 469,485 | 🐛 76 | 📅 2026-05-05 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,918 | 🐛 38 | 📅 2026-05-21 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,918 | 🐛 38 | 📅 2026-05-21 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,449 | 🐛 65 | 🌐 Python | 📅 2026-05-21 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,215 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-23 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,342 | 🐛 127 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 724 | 🐛 28 | 🌐 C | 📅 2026-05-22 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 172 | 🐛 55 | 🌐 Go | 📅 2026-05-23 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,094 | 🐛 342 | 🌐 Go | 📅 2026-05-24 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,583 | 🐛 95 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,591 | 🐛 756 | 🌐 Python | 📅 2026-05-06 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,255 | 🐛 186 | 🌐 TypeScript | 📅 2026-05-23 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,360 | 🐛 50 | 🌐 Go | 📅 2026-04-26 - Web-based PostgreSQL database browser written in Go.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,133 | 🐛 24 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,182 | 🐛 55 | 🌐 Python | 📅 2026-05-12 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,413 | 🐛 257 | 🌐 Go | 📅 2026-05-21 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,638 | 🐛 301 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [Pome](https://github.com/rach/pome) ⭐ 1,075 | 🐛 15 | 🌐 Go | 📅 2020-09-04 - Pome stands for PostgreSQL Metrics. Pome is a PostgreSQL Metrics Dashboard to keep track of the health of your database.
* [PMM](https://github.com/percona/pmm) ⭐ 1,022 | 🐛 187 | 🌐 Go | 📅 2026-05-24 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,507 | 🐛 1,051 | 🌐 C | 📅 2026-05-23 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,837 | 🐛 166 | 🌐 Rust | 📅 2026-05-23 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,837 | 🐛 166 | 🌐 Rust | 📅 2026-05-23 -  Postgres for Search and Analytics
...
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,789 | 🐛 135 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
...
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,647 | 🐛 4 | 🌐 C | 📅 2026-05-24 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,397 | 🐛 69 | 🌐 C++ | 📅 2026-05-20 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 577 | 🐛 12 | 🌐 Perl | 📅 2026-05-18 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,141 | 🐛 55 | 🌐 Go | 📅 2026-05-22 - A high-performance job processing system for Go and Postgres.
...
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,552 | 🐛 46 | 🌐 TypeScript | 📅 2026-05-22 - Queueing jobs in Postgres from Node.js like a boss.
...
* [PEV2](https://github.com/dalibo/pev2) ⭐ 3,475 | 🐛 70 | 🌐 TypeScript | 📅 2026-05-07 - Online Postgres Explain Visualizer.
...
* [pgassistant](https://github.com/beh74/pgassistant-community) ⭐ 31 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-10 - A PostgreSQL tool for developers to help understand, optimize database with LLM and pgTune integration.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,967 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-05-22 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,152 | 🐛 377 | 🌐 Haskell | 📅 2026-05-22 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,471 | 🐛 95 | 🌐 Go | 📅 2026-05-12 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,427 | 🐛 467 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,550 | 🐛 150 | 🌐 Go | 📅 2026-04-30 - Serve a RESTful API from any PostgreSQL database (Golang)
* [pgbadger](https://github.com/darold/pgbadger) ⭐ 4,021 | 🐛 17 | 🌐 Perl | 📅 2026-04-10 - Fast PostgreSQL Log Analyzer.
* [pgsync](https://github.com/ankane/pgsync) ⭐ 3,449 | 🐛 14 | 🌐 Ruby | 📅 2025-12-26 - Tool to sync PostgreSQL data to your local machine.
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,129 | 🐛 79 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
...
* [pgCenter](https://github.com/lesovsky/pgcenter) ⭐ 1,607 | 🐛 1 | 🌐 Go | 📅 2026-05-19 - Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends.
...
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 113 | 🐛 8 | 🌐 Rust | 📅 2026-05-24 - Linter for dangerous Postgres migration patterns in Diesel and SQLx.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,139 | 🐛 506 | 🌐 JavaScript | 📅 2026-05-18, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,554 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,902 | 🐛 30 | 🌐 TypeScript | 📅 2026-05-22, [postgres](https://github.com/porsager/postgres) ⭐ 8,649 | 🐛 256 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,893 | 🐛 51 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,837 | 🐛 254 | 🌐 Go | 📅 2026-05-16, [go-pg](https://github.com/go-pg/pg) ⭐ 5,787 | 🐛 122 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,939 | 🐛 167 | 🌐 Rust | 📅 2026-05-06, [pgx](https://github.com/tcdi/pgx) ⭐ 4,686 | 🐛 342 | 🌐 Rust | 📅 2026-04-22, [wtx](https://github.com/c410-f3r/wtx) ⭐ 356 | 🐛 9 | 🌐 Rust | 📅 2026-05-17
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,689 | 🐛 218 | 🌐 C# | 📅 2026-05-23
...
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 859 | 🐛 18 | 🌐 C | 📅 2026-05-16
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 550 | 🐛 2 | 🌐 Zig | 📅 2026-05-23, [qail-zig](https://github.com/qail-io/qail-zig) ⭐ 3 | 🐛 1 | 🌐 Zig | 📅 2026-05-15
* Common Lisp: [Postmodern](https://github.com/marijnh/Postmodern) ⭐ 429 | 🐛 5 | 🌐 Common Lisp | 📅 2025-07-24
* R: [RPostgres](https://github.com/r-dbi/RPostgres) ⭐ 337 | 🐛 35 | 🌐 R | 📅 2026-05-24, [RPostgreSQL](https://github.com/tomoakin/RPostgreSQL) ⭐ 66 | 🐛 48 | 🌐 C | 📅 2025-03-28
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,666 | 🐛 377 | 🌐 Go | 📅 2026-05-23 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
...
* [Crunchy Operator](https://github.com/CrunchyData/postgres-operator) ⭐ 4,407 | 🐛 157 | 🌐 Go | 📅 2026-05-22 - Production PostgreSQL for Kubernetes, from high availability Postgres clusters to full-scale database-as-a-service.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,492 | 🐛 112 | 🌐 HTML | 📅 2026-05-24
