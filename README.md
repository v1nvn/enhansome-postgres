# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 474,397 | 🐛 81 | 📅 2026-06-02 with stars
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,495 | 🐛 60 | 🌐 Python | 📅 2026-06-09 - Template for PostgreSQL HA with ZooKeeper or etcd.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,254 | 🐛 27 | 🌐 TypeScript | 📅 2026-06-05 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [repmgr](https://github.com/2ndQuadrant/repmgr) ⭐ 1,700 | 🐛 134 | 🌐 C | 📅 2026-03-28 - Open-source tool suite to manage replication and failover in a cluster of PostgreSQL servers.
...
* [Spock](https://github.com/pgEdge/spock) ⭐ 729 | 🐛 30 | 🌐 C | 📅 2026-06-10 - 100% open-source logical multi-master PostgreSQL replication.
...
* [pgrwl](https://github.com/hashmap-kz/pgrwl) ⭐ 175 | 🐛 59 | 🌐 Go | 📅 2026-06-04 - Stream write-ahead logs (WAL) from a PostgreSQL server in real time. A drop-in, container-friendly alternative to pg\_receivewal.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 4,110 | 🐛 326 | 🌐 Go | 📅 2026-06-09 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [pgbackweb](https://github.com/eduardolat/pgbackweb) ⭐ 2,585 | 🐛 96 | 🌐 Go | 📅 2025-11-21 - A Complete Docker-based Postgres backup and maintenance tool with Web UI.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,629 | 🐛 788 | 🌐 Python | 📅 2026-06-01 - Connect to any data source, easily visualize and share your data.
* [Teable](https://github.com/teableio/teable) ⭐ 21,316 | 🐛 188 | 🌐 TypeScript | 📅 2026-06-10 - A Super fast, Real-time, Professional, Developer friendly, No code database.
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,374 | 🐛 53 | 🌐 Go | 📅 2026-06-09 - Web-based PostgreSQL database browser written in Go.
* [Postbird](https://github.com/Paxa/postbird) ⭐ 1,625 | 🐛 53 | 🌐 JavaScript | 📅 2025-06-30 - PostgreSQL Client for macOS.
* [PgManage](https://github.com/commandprompt/pgmanage) ⭐ 1,011 | 🐛 37 | 🌐 PLpgSQL | 📅 2026-06-09 - A modern multi-platform Postgres-centric database client/administration tool.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 5,163 | 🐛 26 | 🌐 Shell | 📅 2026-05-11 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,206 | 🐛 39 | 🌐 Python | 📅 2026-06-03 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,468 | 🐛 257 | 🌐 Go | 📅 2026-06-04 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
* [schemaspy](https://github.com/schemaspy/schemaspy) ⭐ 3,654 | 🐛 301 | 🌐 HTML | 📅 2026-03-05 - SchemaSpy is a JAVA JDBC-compliant tool for generating your database to HTML documentation, including Entity Relationship diagrams
...
* [squix](https://github.com/eduardofuncao/squix) ⭐ 239 | 🐛 7 | 🌐 Go | 📅 2026-06-01 - SQL command-line client with query management and interactive results.
* [sabiql](https://github.com/riii111/sabiql) ⭐ 198 | 🐛 3 | 🌐 Rust | 📅 2026-06-07 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,229 | 🐛 200 | 🌐 C | 📅 2026-06-08 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,729 | 🐛 118 | 🌐 Go | 📅 2026-06-09 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
* [postgres\_exporter](https://github.com/wrouesnel/postgres_exporter) ⭐ 3,542 | 🐛 363 | 🌐 Go | 📅 2026-06-10 - Prometheus exporter for PostgreSQL server metrics.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,040 | 🐛 189 | 🌐 Go | 📅 2026-06-09 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,548 | 🐛 1,047 | 🌐 C | 📅 2026-06-08 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,921 | 🐛 157 | 🌐 Rust | 📅 2026-06-10 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,921 | 🐛 157 | 🌐 Rust | 📅 2026-06-10 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,592 | 🐛 195 | 🌐 C | 📅 2026-06-09 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,807 | 🐛 135 | 🌐 C | 📅 2026-04-21 - Run periodic jobs in PostgreSQL.
* [pg\_partman](https://github.com/pgpartman/pg_partman) ⭐ 2,725 | 🐛 57 | 🌐 PLpgSQL | 📅 2026-03-09 - Partition management extension for PostgreSQL.
* [cstore\_fdw](https://github.com/citusdata/cstore_fdw) ⭐ 1,784 | 🐛 70 | 🌐 C | 📅 2021-03-08 - Columnar store for analytics with PostgreSQL.
* [HypoPG](https://github.com/HypoPG/hypopg) ⭐ 1,658 | 🐛 4 | 🌐 C | 📅 2026-05-24 - HypoPG provides hypothetical/virtual indexes feature.
* [pgRouting](https://github.com/pgRouting/pgrouting) ⭐ 1,406 | 🐛 70 | 🌐 C++ | 📅 2026-05-20 - pgRouting extends the PostGIS/PostgreSQL geospatial database to provide geospatial routing and other network analysis functionality.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 764 | 🐛 1 | 🌐 C | 📅 2026-06-05 - Extension that allows to check plpgsql source code.
...
* [pg\_stat\_monitor](https://github.com/percona/pg_stat_monitor) ⭐ 580 | 🐛 12 | 🌐 Perl | 📅 2026-06-09 - Query Performance Monitoring tool for PostgreSQL.
...
* [river](https://github.com/riverqueue/river) ⭐ 5,198 | 🐛 58 | 🌐 Go | 📅 2026-06-08 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,939 | 🐛 38 | 🌐 PLpgSQL | 📅 2026-05-20 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,614 | 🐛 53 | 🌐 TypeScript | 📅 2026-06-04 - Queueing jobs in Postgres from Node.js like a boss.
...
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,717 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-09 - Online version of PostgreSQL configuration wizard.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,043 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-06-08 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,211 | 🐛 381 | 🌐 Haskell | 📅 2026-06-09 - Serves a fully RESTful API from any existing PostgreSQL database.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,924 | 🐛 155 | 🌐 TypeScript | 📅 2026-06-08 - Instant GraphQL API or GraphQL schema for your PostgreSQL database
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,497 | 🐛 94 | 🌐 Go | 📅 2026-06-08 - Zero-downtime, reversible, schema migrations for Postgres
...
* [sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,134 | 🐛 81 | 🌐 Perl | 📅 2026-01-25 - Tool for managing versioned schema deployment
...
* [Greenmask](https://github.com/GreenmaskIO/greenmask) ⭐ 1,690 | 🐛 52 | 🌐 Go | 📅 2026-05-29 - Database anonymization and synthetic data generation tool for MySQL and PostgreSQL.
* [pgCenter](https://github.com/lesovsky/pgcenter) ⭐ 1,610 | 🐛 1 | 🌐 Go | 📅 2026-05-19 - Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends.
...
* [pg\_timetable](https://github.com/cybertec-postgresql/pg_timetable) ⭐ 1,366 | 🐛 0 | 🌐 Go | 📅 2026-04-21 - Advanced job scheduler for PostgreSQL.
...
* [ldap2pg](https://github.com/dalibo/ldap2pg) ⭐ 232 | 🐛 18 | 🌐 Go | 📅 2026-06-09 - Synchronize roles and privileges from YML and LDAP.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 140 | 🐛 7 | 🌐 Python | 📅 2026-06-04 - Spot vulnerabilities in PostgreSQL extension scripts.
...
* [NServiceBus.Transport.PostgreSql](https://github.com/Particular/NServiceBus.SqlServer) ⭐ 47 | 🐛 39 | 🌐 C# | 📅 2026-06-09 - The NServiceBus.Transport.PostgreSql library allows .NET developers to [use a PostgreSQL database as a message broker](https://docs.particular.net/transports/postgresql). (Commerical Software)
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,153 | 🐛 512 | 🌐 JavaScript | 📅 2026-06-02, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,553 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 15 | 🌐 TypeScript | 📅 2026-04-10, [slonik](https://github.com/gajus/slonik) ⭐ 4,904 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-10, [postgres](https://github.com/porsager/postgres) ⭐ 8,656 | 🐛 259 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,898 | 🐛 52 | 🌐 Go | 📅 2026-05-12, [pgx](https://github.com/jackc/pgx) ⭐ 13,903 | 🐛 247 | 🌐 Go | 📅 2026-06-03, [go-pg](https://github.com/go-pg/pg) ⭐ 5,788 | 🐛 121 | 🌐 Go | 📅 2026-05-29
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,939 | 🐛 170 | 🌐 Rust | 📅 2026-06-09, [pgx](https://github.com/tcdi/pgx) ⭐ 4,706 | 🐛 321 | 🌐 Rust | 📅 2026-06-08, [wtx](https://github.com/c410-f3r/wtx) ⭐ 358 | 🐛 9 | 🌐 Rust | 📅 2026-06-09
...
* Elixir: [postgrex](https://github.com/elixir-ecto/postgrex) ⭐ 1,211 | 🐛 7 | 🌐 Elixir | 📅 2026-05-13
* Ruby: [pg](https://github.com/ged/ruby-pg) ⭐ 870 | 🐛 18 | 🌐 C | 📅 2026-06-08
* Zig: [pg.zig](https://github.com/karlseguin/pg.zig) ⭐ 563 | 🐛 3 | 🌐 Zig | 📅 2026-06-09, [qail-zig](https://github.com/qail-io/qail-zig) ⭐ 3 | 🐛 1 | 🌐 Zig | 📅 2026-05-15
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,770 | 🐛 384 | 🌐 Go | 📅 2026-06-10 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,181 | 🐛 563 | 🌐 Go | 📅 2026-06-04 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [StackGres Operator](https://github.com/ongres/stackgres/) ⭐ 1,406 | 🐛 1 | 🌐 Java | 📅 2026-06-09 -  Full Stack PostgreSQL on Kubernetes.
...
* [pagila](https://github.com/xzilla/pagila) ⭐ 74 | 🐛 1 | 🌐 PLpgSQL | 📅 2026-03-26 - Pagila, Postgres Sample Database
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,499 | 🐛 114 | 🌐 HTML | 📅 2026-06-10
