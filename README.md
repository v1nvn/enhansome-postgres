# Awesome Postgres [![awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,659 | 🐛 60 | 📅 2026-04-02 with stars
...
:elephant: Contributions welcome. Add links through [pull requests](https://github.com/dhamaniasad/awesome-postgres/pulls) ⭐ 11,817 | 🐛 24 | 📅 2026-03-28 or create an [issue](https://github.com/dhamaniasad/awesome-postgres/issues) ⭐ 11,817 | 🐛 24 | 📅 2026-03-28 to start a discussion. Please take a look at the [contribution guidelines](origin/CONTRIBUTING.md).
...
* [Patroni](https://github.com/zalando/patroni) ⭐ 8,323 | 🐛 68 | 🌐 Python | 📅 2026-04-03 - Template for PostgreSQL HA with ZooKeeper or etcd.
* [Stolon](https://github.com/sorintlab/stolon) ⭐ 4,813 | 🐛 152 | 🌐 Go | 📅 2024-07-08 - PostgreSQL HA based on Consul or etcd, with Kubernetes integration.
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,106 | 🐛 28 | 🌐 TypeScript | 📅 2026-04-06 - Autobase for PostgreSQL® is an open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [repmgr](https://github.com/2ndQuadrant/repmgr) ⭐ 1,686 | 🐛 135 | 🌐 C | 📅 2026-03-28 - Open-source tool suite to manage replication and failover in a cluster of PostgreSQL servers.
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,335 | 🐛 123 | 🌐 C | 📅 2025-11-17 - Postgres extension and service for automated failover and high-availability.
* [Spock](https://github.com/pgEdge/spock) ⭐ 692 | 🐛 26 | 🌐 C | 📅 2026-04-06 - 100% open-source logical multi-master PostgreSQL replication.
...
* [wal-g](https://github.com/wal-g/wal-g) ⭐ 3,995 | 🐛 336 | 🌐 Go | 📅 2026-04-06 - The successor of WAL-E rewritten in Go. Currently supports cloud object storage services by AWS (S3), Google Cloud (GCS), Azure, as well as OpenStack Swift, MinIO, and file system storages. Supports block-level incremental backups, offloading backup tasks to a standby server, provides parallelization and throttling options. In addition to Postgres, WAL-G can be used for MySQL and MongoDB databases.
...
* [Teable](https://github.com/teableio/teable) ⭐ 21,087 | 🐛 163 | 🌐 TypeScript | 📅 2026-04-07 - A Super fast, Real-time, Professional, Developer friendly, No code database.
...
* [Pigsty](https://github.com/Vonng/pigsty) ⭐ 4,966 | 🐛 21 | 🌐 Shell | 📅 2026-03-23 - Battery-Included Open-Source Distribution for PostgreSQL with ultimate observability & Database-as-Code toolbox for developers.

### CLI

* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,095 | 🐛 65 | 🌐 Python | 📅 2026-04-01 - Postgres CLI with autocompletion and syntax highlighting
* [atlas](https://github.com/ariga/atlas) ⭐ 8,246 | 🐛 254 | 🌐 Go | 📅 2026-03-30 - Atlas is a tool for managing and migrating database schemas using modern DevOps principles.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 158 | 🐛 1 | 🌐 Rust | 📅 2026-04-06 - A fast, driver-less TUI to browse, query, and edit PostgreSQL databases.
...
* [Apache Cloudberry](https://github.com/apache/cloudberry) ⭐ 1,199 | 🐛 160 | 🌐 C | 📅 2026-04-07 - And MPP PostgreSQL fork. Open source alternative to Greenplum Database.
...
* [coroot](https://github.com/coroot/coroot) ⭐ 7,549 | 🐛 114 | 🌐 Go | 📅 2026-04-03 - Coroot is an open-source APM & Observability tool, a DataDog and NewRelic alternative. Powered by eBPF for rapid insights into system performance.
...
* [PMM](https://github.com/percona/pmm) ⭐ 1,003 | 🐛 171 | 🌐 Go | 📅 2026-04-06 - Percona Monitoring and Management (PMM) is a Free and Open Source platform for monitoring and managing PostgreSQL, MySQL, and MongoDB.
...
* [pg\_ash](https://github.com/NikolayS/pg_ash) ⭐ 210 | 🐛 4 | 🌐 PLpgSQL | 📅 2026-04-07 - Active Session History for PostgreSQL. Samples pg\_stat\_activity once per second via pg\_cron, stores encoded snapshots, and provides 32 SQL functions for wait event analysis. Pure SQL, no extensions, works on managed providers (RDS, Cloud SQL, Supabase, etc.).
* [check\_pgactivity](https://github.com/OPMDG/check_pgactivity) ⭐ 181 | 🐛 58 | 🌐 Perl | 📅 2026-04-01 - check\_pgactivity is designed to monitor PostgreSQL clusters from Nagios. It offers many options to measure and monitor useful performance metrics.
...
* [Citus](https://github.com/citusdata/citus) ⭐ 12,417 | 🐛 1,059 | 🌐 C | 📅 2026-04-05 - Scalable PostgreSQL cluster for real-time workloads.
* [pg\_search](https://github.com/paradedb/paradedb) ⭐ 8,634 | 🐛 158 | 🌐 Rust | 📅 2026-04-07 - pg\_search is a PostgreSQL extension that enables full-text search over SQL tables using the BM25 algorithm, the state-of-the-art ranking function for full-text search.
* [ParadeDB](https://github.com/paradedb/paradedb) ⭐ 8,634 | 🐛 158 | 🌐 Rust | 📅 2026-04-07 -  Postgres for Search and Analytics
...
* [AGE](https://github.com/apache/age) ⭐ 4,375 | 🐛 196 | 🌐 C | 📅 2026-04-06 - Adds fully-functional graph database support including Cypher queries.
* [pg\_cron](https://github.com/citusdata/pg_cron) ⭐ 3,725 | 🐛 135 | 🌐 C | 📅 2026-04-02 - Run periodic jobs in PostgreSQL.
...
* [plpgsql\_check](https://github.com/okbob/plpgsql_check) ⭐ 747 | 🐛 0 | 🌐 C | 📅 2026-04-06 - Extension that allows to check plpgsql source code.
...
* [river](https://github.com/riverqueue/river) ⭐ 4,983 | 🐛 47 | 🌐 Go | 📅 2026-04-06 - A high-performance job processing system for Go and Postgres.
* [pgmq](https://github.com/pgmq/pgmq) ⭐ 4,732 | 🐛 40 | 🌐 PLpgSQL | 📅 2026-04-07 - A lightweight message queue. Like AWS SQS and RSMQ but on Postgres.
* [pgBoss](https://github.com/timgit/pg-boss) ⭐ 3,357 | 🐛 38 | 🌐 TypeScript | 📅 2026-04-06 - Queueing jobs in Postgres from Node.js like a boss.
...
* [pgtune](https://github.com/le0pard/pgtune) ⭐ 2,685 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-06 - Online version of PostgreSQL configuration wizard.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 31,931 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-04-02 - Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 26,725 | 🐛 386 | 🌐 Haskell | 📅 2026-04-06 - Serves a fully RESTful API from any existing PostgreSQL database.
...
* [pgroll](https://github.com/xataio/pgroll) ⭐ 6,411 | 🐛 93 | 🌐 Go | 📅 2026-02-17 - Zero-downtime, reversible, schema migrations for Postgres
* [pgloader](https://github.com/dimitri/pgloader) ⭐ 6,372 | 🐛 465 | 🌐 Common Lisp | 📅 2025-06-04 - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
* [pREST](https://github.com/prest/prest) ⭐ 4,539 | 🐛 147 | 🌐 Go | 📅 2026-03-07 - Serve a RESTful API from any PostgreSQL database (Golang)
...
* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 107 | 🐛 8 | 🌐 Rust | 📅 2026-04-07 - Linter for dangerous Postgres migration patterns in Diesel and SQLx.
...
* Node: [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,109 | 🐛 514 | 🌐 JavaScript | 📅 2026-04-02, [pg-promise](https://github.com/vitaly-t/pg-promise) ⭐ 3,550 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-06, [pogi](https://github.com/holdfenytolvaj/pogi) ⭐ 139 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-02, [slonik](https://github.com/gajus/slonik) ⭐ 4,899 | 🐛 31 | 🌐 TypeScript | 📅 2026-04-06, [postgres](https://github.com/porsager/postgres) ⭐ 8,599 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-05
* Go: [pq](https://github.com/lib/pq) ⭐ 9,846 | 🐛 57 | 🌐 Go | 📅 2026-04-03, [pgx](https://github.com/jackc/pgx) ⭐ 13,579 | 🐛 244 | 🌐 Go | 📅 2026-04-03, [go-pg](https://github.com/go-pg/pg) ⭐ 5,786 | 🐛 121 | 🌐 Go | 📅 2025-11-26
* Rust: [rust-postgresql](https://github.com/sfackler/rust-postgres) ⭐ 3,922 | 🐛 153 | 🌐 Rust | 📅 2026-04-04, [pgx](https://github.com/tcdi/pgx) ⭐ 4,436 | 🐛 337 | 🌐 Rust | 📅 2026-04-06, [wtx](https://github.com/c410-f3r/wtx) ⭐ 346 | 🐛 12 | 🌐 Rust | 📅 2026-04-06
* .Net/.Net Core: [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,672 | 🐛 217 | 🌐 C# | 📅 2026-04-04
...
* [CloudNativePG operator](https://github.com/cloudnative-pg/cloudnative-pg) ⭐ 8,363 | 🐛 326 | 🌐 Go | 📅 2026-04-07 - A comprehensive platform designed to seamlessly manage PostgreSQL databases within Kubernetes environments.
* [Zalando Operator](https://github.com/zalando/postgres-operator) ⭐ 5,133 | 🐛 567 | 🌐 Go | 📅 2026-04-06 - Creates and manages PostgreSQL clusters running in Kubernetes.
...
* [Digoal's PostgreSQL and Technical blog(Chinese Language)](https://github.com/digoal/blog/blob/master/README.md) ⭐ 8,462 | 🐛 89 | 🌐 HTML | 📅 2026-04-06
